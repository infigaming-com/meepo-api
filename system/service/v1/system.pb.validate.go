...
// Validate checks the field values on GetCurrenciesRequest_CurrencyFilter with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *GetCurrenciesRequest_CurrencyFilter) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetCurrenciesRequest_CurrencyFilter
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GetCurrenciesRequest_CurrencyFilterMultiError, or nil if none found.
func (m *GetCurrenciesRequest_CurrencyFilter) ValidateAll() error {
	return m.validate(true)
}

func (m *GetCurrenciesRequest_CurrencyFilter) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetCurrenciesRequest_CurrencyFilterMultiError(errors)
	}

	return nil
}

// GetCurrenciesRequest_CurrencyFilterMultiError is an error wrapping multiple
// validation errors returned by
// GetCurrenciesRequest_CurrencyFilter.ValidateAll() if the designated
// constraints aren't met.
type GetCurrenciesRequest_CurrencyFilterMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetCurrenciesRequest_CurrencyFilterMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetCurrenciesRequest_CurrencyFilterMultiError) AllErrors() []error { return m }

// GetCurrenciesRequest_CurrencyFilterValidationError is the validation error
// returned by GetCurrenciesRequest_CurrencyFilter.Validate if the designated
// constraints aren't met.
type GetCurrenciesRequest_CurrencyFilterValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetCurrenciesRequest_CurrencyFilterValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetCurrenciesRequest_CurrencyFilterValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetCurrenciesRequest_CurrencyFilterValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetCurrenciesRequest_CurrencyFilterValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetCurrenciesRequest_CurrencyFilterValidationError) ErrorName() string {
	return "GetCurrenciesRequest_CurrencyFilterValidationError"
}

// Error satisfies the builtin error interface
func (e GetCurrenciesRequest_CurrencyFilterValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetCurrenciesRequest_CurrencyFilter.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetCurrenciesRequest_CurrencyFilterValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetCurrenciesRequest_CurrencyFilterValidationError{}
