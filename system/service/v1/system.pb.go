...
type GetCurrenciesRequest struct {
	state         protoimpl.MessageState               `protogen:"open.v1"`
	Filter        *GetCurrenciesRequest_CurrencyFilter `protobuf:"bytes,1,opt,name=filter,proto3,oneof" json:"filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetCurrenciesRequest) GetFilter() *GetCurrenciesRequest_CurrencyFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
type GetCurrenciesRequest_CurrencyFilter struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetCurrenciesRequest_CurrencyFilter) Reset() {
	*x = GetCurrenciesRequest_CurrencyFilter{}
	mi := &file_system_service_v1_system_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCurrenciesRequest_CurrencyFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCurrenciesRequest_CurrencyFilter) ProtoMessage() {}

func (x *GetCurrenciesRequest_CurrencyFilter) ProtoReflect() protoreflect.Message {
	mi := &file_system_service_v1_system_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCurrenciesRequest_CurrencyFilter.ProtoReflect.Descriptor instead.
func (*GetCurrenciesRequest_CurrencyFilter) Descriptor() ([]byte, []int) {
	return file_system_service_v1_system_proto_rawDescGZIP(), []int{5, 0}
}

func (x *GetCurrenciesRequest_CurrencyFilter) GetCurrencies() []string {
	if x != nil {
		return x.Currencies
	}
	return nil
...
const file_system_service_v1_system_proto_rawDesc = "" +
	...
	"\bcurrency\x18\x01 \x01(\v2\x1b.system.service.v1.CurrencyR\bcurrency\"\xa8\x01\n" +
	"\x14GetCurrenciesRequest\x12S\n" +
	"\x06filter\x18\x01 \x01(\v26.system.service.v1.GetCurrenciesRequest.CurrencyFilterH\x00R\x06filter\x88\x01\x01\x1a0\n" +
...
var file_system_service_v1_system_proto_goTypes = []any{
	...
	(*GetCurrenciesRequest_CurrencyFilter)(nil), // 7: system.service.v1.GetCurrenciesRequest.CurrencyFilter
}
var file_system_service_v1_system_proto_depIdxs = []int32{
	...
	7, // 1: system.service.v1.GetCurrenciesRequest.filter:type_name -> system.service.v1.GetCurrenciesRequest.CurrencyFilter
	...
	4, // 7: system.service.v1.System.UpdateCurrency:output_type -> system.service.v1.UpdateCurrencyResponse
	6, // 8: system.service.v1.System.GetCurrencies:output_type -> system.service.v1.GetCurrenciesResponse
