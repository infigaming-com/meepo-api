...
func (x *GetCurrenciesRequest) GetEnabled() bool {
	if x != nil && x.Enabled != nil {
		return *x.Enabled
	}
	return false
...
func (x *GetCurrenciesRequest) GetHidden() bool {
	if x != nil && x.Hidden != nil {
		return *x.Hidden
	}
	return false
...
const file_system_service_v1_system_proto_rawDesc = "" +
	...
	"\x0edecimal_places\x18\a \x01(\x05R\rdecimalPlaces\"M\n" +
	"\x12AddCurrencyRequest\x127\n" +
	"\bcurrency\x18\x01 \x01(\v2\x1b.system.service.v1.CurrencyR\bcurrency\"\x15\n" +
	...
	"\bcurrency\x18\x01 \x01(\v2\x1b.system.service.v1.CurrencyR\bcurrency\"\x89\x01\n" +
	"\x14GetCurrenciesRequest\x12\x1d\n" +
	"\aenabled\x18\x01 \x01(\bH\x00R\aenabled\x88\x01\x01\x12\x1b\n" +
	"\x06hidden\x18\x02 \x01(\bH\x01R\x06hidden\x88\x01\x01\x12\x1e\n" +
	"\n" +
...
var file_system_service_v1_system_proto_depIdxs = []int32{
	...
	0, // 1: system.service.v1.UpdateCurrencyResponse.currency:type_name -> system.service.v1.Currency
