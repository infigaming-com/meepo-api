...
func (x *ContributionReportItem) GetRegistrationIp() string {
	if x != nil {
...
func (x *ContributionReportItem) GetLastLoginDeviceType() string {
	if x != nil {
...
func (x *ContributionReportItem) GetLastLoginIp() string {
	if x != nil {
...
const file_affiliate_service_v1_commission_report_proto_rawDesc = "" +
	...
	"\rlast_login_ip\x18, \x01(\tR\vlastLoginIp\"\xb7\x01\n" +
