...
func (x *ListAllCommissionPlansRequest) GetInitiatorOperatorContext() *common.OperatorContext {
	if x != nil {
...
type ListAllCommissionPlansResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	CommissionPlans []*CommissionPlan      `protobuf:"bytes,1,rep,name=commission_plans,json=commissionPlans,proto3" json:"commission_plans,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
...
func (x *ListAllCommissionPlansResponse) Reset() {
	*x = ListAllCommissionPlansResponse{}
	mi := &file_affiliate_service_v1_commission_plan_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListAllCommissionPlansResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListAllCommissionPlansResponse) ProtoMessage() {}

func (x *ListAllCommissionPlansResponse) ProtoReflect() protoreflect.Message {
	mi := &file_affiliate_service_v1_commission_plan_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListAllCommissionPlansResponse.ProtoReflect.Descriptor instead.
func (*ListAllCommissionPlansResponse) Descriptor() ([]byte, []int) {
	return file_affiliate_service_v1_commission_plan_proto_rawDescGZIP(), []int{12}
}

func (x *ListAllCommissionPlansResponse) GetCommissionPlans() []*CommissionPlan {
	if x != nil {
		return x.CommissionPlans
	}
	return nil
...
func (x *ListAffiliateCommissionPlansRequest) GetOperatorContext() *common.OperatorContext {
	if x != nil {
		return x.OperatorContext
	}
	return nil
...
func (x *ListAffiliateCommissionPlansRequest) GetAffiliateId() int64 {
	if x != nil {
		return x.AffiliateId
	}
	return 0
...
func (*FlatFeeConfig) Descriptor() ([]byte, []int) {
	return file_affiliate_service_v1_commission_plan_proto_rawDescGZIP(), []int{36}
}
...
func (x *ListAffiliateCommissionPlansResponse_AffiliateCommissionPlan) Reset() {
	*x = ListAffiliateCommissionPlansResponse_AffiliateCommissionPlan{}
	mi := &file_affiliate_service_v1_commission_plan_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListAffiliateCommissionPlansResponse_AffiliateCommissionPlan) Descriptor() ([]byte, []int) {
	return file_affiliate_service_v1_commission_plan_proto_rawDescGZIP(), []int{14, 0}
}
...
const file_affiliate_service_v1_commission_plan_proto_rawDesc = "" +
	...
	"\x1cDeleteCommissionPlanResponse\"\x95\x02\n" +
	...
	"\x06status\x18\x03 \x01(\tH\x00R\x06status\x88\x01\x01\x12Y\n" +
	...
	"\x10commission_plans\x18\x01 \x03(\v2(.api.affiliate.service.v1.CommissionPlanR\x0fcommissionPlans\"\xe2\x01\n" +
	"#ListAffiliateCommissionPlansRequest\x12F\n" +
	"\x10operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x0foperatorContext\x12!\n" +
	"\faffiliate_id\x18\x02 \x01(\x03R\vaffiliateId\x12\x17\n" +
...
var file_affiliate_service_v1_commission_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_affiliate_service_v1_commission_plan_proto_goTypes = []any{
	...
	(*ListAffiliateCommissionPlansRequest)(nil),                          // 13: api.affiliate.service.v1.ListAffiliateCommissionPlansRequest
	(*ListAffiliateCommissionPlansResponse)(nil),                         // 14: api.affiliate.service.v1.ListAffiliateCommissionPlansResponse
	(*CommissionPlanConfig)(nil),                                         // 15: api.affiliate.service.v1.CommissionPlanConfig
	(*CPAConfig)(nil),                                                    // 16: api.affiliate.service.v1.CPAConfig
	(*FlatCommission)(nil),                                               // 17: api.affiliate.service.v1.FlatCommission
	(*FlatByCountriesCommission)(nil),                                    // 18: api.affiliate.service.v1.FlatByCountriesCommission
	(*CountryCommissionGroup)(nil),                                       // 19: api.affiliate.service.v1.CountryCommissionGroup
	(*ProgressiveCommission)(nil),                                        // 20: api.affiliate.service.v1.ProgressiveCommission
	(*ProgressiveCommissionRange)(nil),                                   // 21: api.affiliate.service.v1.ProgressiveCommissionRange
	(*ProgressiveByCountriesCommission)(nil),                             // 22: api.affiliate.service.v1.ProgressiveByCountriesCommission
	(*CountryProgressiveGroup)(nil),                                      // 23: api.affiliate.service.v1.CountryProgressiveGroup
	(*Qualification)(nil),                                                // 24: api.affiliate.service.v1.Qualification
	(*AdvancedOptions)(nil),                                              // 25: api.affiliate.service.v1.AdvancedOptions
	(*RevShareConfig)(nil),                                               // 26: api.affiliate.service.v1.RevShareConfig
	(*FlatRateCommission)(nil),                                           // 27: api.affiliate.service.v1.FlatRateCommission
	(*FlatByCountriesRateCommission)(nil),                                // 28: api.affiliate.service.v1.FlatByCountriesRateCommission
	(*CountryRateGroup)(nil),                                             // 29: api.affiliate.service.v1.CountryRateGroup
	(*ProgressiveRateCommission)(nil),                                    // 30: api.affiliate.service.v1.ProgressiveRateCommission
	(*RateRange)(nil),                                                    // 31: api.affiliate.service.v1.RateRange
	(*ProgressiveByCountriesRateCommission)(nil),                         // 32: api.affiliate.service.v1.ProgressiveByCountriesRateCommission
	(*CountryProgressiveRateGroup)(nil),                                  // 33: api.affiliate.service.v1.CountryProgressiveRateGroup
	(*CPLConfig)(nil),                                                    // 34: api.affiliate.service.v1.CPLConfig
	(*CPCConfig)(nil),                                                    // 35: api.affiliate.service.v1.CPCConfig
	(*FlatFeeConfig)(nil),                                                // 36: api.affiliate.service.v1.FlatFeeConfig
	(*ListAffiliateCommissionPlansResponse_AffiliateCommissionPlan)(nil), // 37: api.affiliate.service.v1.ListAffiliateCommissionPlansResponse.AffiliateCommissionPlan
...
var file_affiliate_service_v1_commission_plan_proto_depIdxs = []int32{
	38, // 0: api.affiliate.service.v1.CreateCommissionPlanRequest.operator_context:type_name -> api.common.OperatorContext
	15, // 1: api.affiliate.service.v1.CreateCommissionPlanRequest.plan_config:type_name -> api.affiliate.service.v1.CommissionPlanConfig
	38, // 2: api.affiliate.service.v1.UpdateCommissionPlanRequest.operator_context:type_name -> api.common.OperatorContext
	15, // 3: api.affiliate.service.v1.UpdateCommissionPlanRequest.plan_config:type_name -> api.affiliate.service.v1.CommissionPlanConfig
	38, // 4: api.affiliate.service.v1.GetCommissionPlanRequest.operator_context:type_name -> api.common.OperatorContext
	38, // 5: api.affiliate.service.v1.GetCommissionPlanResponse.operator_context:type_name -> api.common.OperatorContext
	15, // 6: api.affiliate.service.v1.GetCommissionPlanResponse.plan_config:type_name -> api.affiliate.service.v1.CommissionPlanConfig
	38, // 7: api.affiliate.service.v1.ListCommissionPlansRequest.operator_context:type_name -> api.common.OperatorContext
	...
	38, // 9: api.affiliate.service.v1.DeleteCommissionPlanRequest.operator_context:type_name -> api.common.OperatorContext
	38, // 10: api.affiliate.service.v1.ListAllCommissionPlansRequest.target_operator_context:type_name -> api.common.OperatorContext
	38, // 11: api.affiliate.service.v1.ListAllCommissionPlansRequest.initiator_operator_context:type_name -> api.common.OperatorContext
	...
	38, // 13: api.affiliate.service.v1.ListAffiliateCommissionPlansRequest.operator_context:type_name -> api.common.OperatorContext
	37, // 14: api.affiliate.service.v1.ListAffiliateCommissionPlansResponse.commission_plans:type_name -> api.affiliate.service.v1.ListAffiliateCommissionPlansResponse.AffiliateCommissionPlan
	16, // 15: api.affiliate.service.v1.CommissionPlanConfig.cpa:type_name -> api.affiliate.service.v1.CPAConfig
	26, // 16: api.affiliate.service.v1.CommissionPlanConfig.revshare:type_name -> api.affiliate.service.v1.RevShareConfig
	34, // 17: api.affiliate.service.v1.CommissionPlanConfig.cpl:type_name -> api.affiliate.service.v1.CPLConfig
	35, // 18: api.affiliate.service.v1.CommissionPlanConfig.cpc:type_name -> api.affiliate.service.v1.CPCConfig
	36, // 19: api.affiliate.service.v1.CommissionPlanConfig.flat_fee:type_name -> api.affiliate.service.v1.FlatFeeConfig
	17, // 20: api.affiliate.service.v1.CPAConfig.flat:type_name -> api.affiliate.service.v1.FlatCommission
	18, // 21: api.affiliate.service.v1.CPAConfig.flat_by_countries:type_name -> api.affiliate.service.v1.FlatByCountriesCommission
	20, // 22: api.affiliate.service.v1.CPAConfig.progressive:type_name -> api.affiliate.service.v1.ProgressiveCommission
	22, // 23: api.affiliate.service.v1.CPAConfig.progressive_by_countries:type_name -> api.affiliate.service.v1.ProgressiveByCountriesCommission
	24, // 24: api.affiliate.service.v1.CPAConfig.qualification:type_name -> api.affiliate.service.v1.Qualification
	25, // 25: api.affiliate.service.v1.CPAConfig.advanced_options:type_name -> api.affiliate.service.v1.AdvancedOptions
	19, // 26: api.affiliate.service.v1.FlatByCountriesCommission.country_groups:type_name -> api.affiliate.service.v1.CountryCommissionGroup
	21, // 27: api.affiliate.service.v1.ProgressiveCommission.ranges:type_name -> api.affiliate.service.v1.ProgressiveCommissionRange
	23, // 28: api.affiliate.service.v1.ProgressiveByCountriesCommission.country_groups:type_name -> api.affiliate.service.v1.CountryProgressiveGroup
	21, // 29: api.affiliate.service.v1.ProgressiveByCountriesCommission.other_countries_ranges:type_name -> api.affiliate.service.v1.ProgressiveCommissionRange
	21, // 30: api.affiliate.service.v1.CountryProgressiveGroup.ranges:type_name -> api.affiliate.service.v1.ProgressiveCommissionRange
	27, // 31: api.affiliate.service.v1.RevShareConfig.flat:type_name -> api.affiliate.service.v1.FlatRateCommission
	28, // 32: api.affiliate.service.v1.RevShareConfig.flat_by_countries:type_name -> api.affiliate.service.v1.FlatByCountriesRateCommission
	30, // 33: api.affiliate.service.v1.RevShareConfig.progressive:type_name -> api.affiliate.service.v1.ProgressiveRateCommission
	32, // 34: api.affiliate.service.v1.RevShareConfig.progressive_by_countries:type_name -> api.affiliate.service.v1.ProgressiveByCountriesRateCommission
	24, // 35: api.affiliate.service.v1.RevShareConfig.qualification:type_name -> api.affiliate.service.v1.Qualification
	29, // 36: api.affiliate.service.v1.FlatByCountriesRateCommission.country_groups:type_name -> api.affiliate.service.v1.CountryRateGroup
	31, // 37: api.affiliate.service.v1.ProgressiveRateCommission.ranges:type_name -> api.affiliate.service.v1.RateRange
	33, // 38: api.affiliate.service.v1.ProgressiveByCountriesRateCommission.country_groups:type_name -> api.affiliate.service.v1.CountryProgressiveRateGroup
	31, // 39: api.affiliate.service.v1.ProgressiveByCountriesRateCommission.other_countries_ranges:type_name -> api.affiliate.service.v1.RateRange
	31, // 40: api.affiliate.service.v1.CountryProgressiveRateGroup.ranges:type_name -> api.affiliate.service.v1.RateRange
	17, // 41: api.affiliate.service.v1.CPLConfig.flat:type_name -> api.affiliate.service.v1.FlatCommission
	18, // 42: api.affiliate.service.v1.CPLConfig.flat_by_countries:type_name -> api.affiliate.service.v1.FlatByCountriesCommission
	20, // 43: api.affiliate.service.v1.CPLConfig.progressive:type_name -> api.affiliate.service.v1.ProgressiveCommission
	22, // 44: api.affiliate.service.v1.CPLConfig.progressive_by_countries:type_name -> api.affiliate.service.v1.ProgressiveByCountriesCommission
	25, // 45: api.affiliate.service.v1.CPLConfig.advanced_options:type_name -> api.affiliate.service.v1.AdvancedOptions
	17, // 46: api.affiliate.service.v1.CPCConfig.flat:type_name -> api.affiliate.service.v1.FlatCommission
	18, // 47: api.affiliate.service.v1.CPCConfig.flat_by_countries:type_name -> api.affiliate.service.v1.FlatByCountriesCommission
	39, // 48: api.affiliate.service.v1.FlatFeeConfig.start_time:type_name -> google.protobuf.Timestamp
	15, // 49: api.affiliate.service.v1.ListAffiliateCommissionPlansResponse.AffiliateCommissionPlan.plan_config:type_name -> api.affiliate.service.v1.CommissionPlanConfig
...
func file_affiliate_service_v1_commission_plan_proto_init() {
	...
	file_affiliate_service_v1_commission_plan_proto_msgTypes[28].OneofWrappers = []any{}
	...
	file_affiliate_service_v1_commission_plan_proto_msgTypes[35].OneofWrappers = []any{}
	type x struct{}
