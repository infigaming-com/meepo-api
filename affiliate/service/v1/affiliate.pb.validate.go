...
// Validate checks the field values on ListUsersResponse_CommissionPlan with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *ListUsersResponse_CommissionPlan) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListUsersResponse_CommissionPlan with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// ListUsersResponse_CommissionPlanMultiError, or nil if none found.
func (m *ListUsersResponse_CommissionPlan) ValidateAll() error {
	return m.validate(true)
}

func (m *ListUsersResponse_CommissionPlan) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ListUsersResponse_CommissionPlanMultiError(errors)
	}

	return nil
}

// ListUsersResponse_CommissionPlanMultiError is an error wrapping multiple
// validation errors returned by
// ListUsersResponse_CommissionPlan.ValidateAll() if the designated
// constraints aren't met.
type ListUsersResponse_CommissionPlanMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListUsersResponse_CommissionPlanMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListUsersResponse_CommissionPlanMultiError) AllErrors() []error { return m }

// ListUsersResponse_CommissionPlanValidationError is the validation error
// returned by ListUsersResponse_CommissionPlan.Validate if the designated
// constraints aren't met.
type ListUsersResponse_CommissionPlanValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListUsersResponse_CommissionPlanValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListUsersResponse_CommissionPlanValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListUsersResponse_CommissionPlanValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListUsersResponse_CommissionPlanValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListUsersResponse_CommissionPlanValidationError) ErrorName() string {
	return "ListUsersResponse_CommissionPlanValidationError"
}

// Error satisfies the builtin error interface
func (e ListUsersResponse_CommissionPlanValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListUsersResponse_CommissionPlan.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListUsersResponse_CommissionPlanValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListUsersResponse_CommissionPlanValidationError{}
