...
func IsOperatorNotFoundInContext(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_OPERATOR_NOT_FOUND_IN_CONTEXT.String() && e.Code == 500
}

func ErrorOperatorNotFoundInContext(format string, args ...interface{}) *errors.Error {
	return errors.New(500, ErrorReason_OPERATOR_NOT_FOUND_IN_CONTEXT.String(), fmt.Sprintf(format, args...))
}
