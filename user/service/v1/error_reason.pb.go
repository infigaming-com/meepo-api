...
const file_user_service_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\"user/service/v1/error_reason.proto\x12\x13api.user.service.v1\x1a\x13errors/errors.proto*\xd5\n" +
	"\n" +
	...
	"\x0eROLE_NOT_FOUND\x10\xbaN\x1a\x04\xa8E\x94\x03\x1a\x04\xa0E\xf4\x03BO\n" +
