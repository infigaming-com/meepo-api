...
func (UnimplementedUserFileStoreServer) UploadKycFile(context.Context, *UploadKycRequest) (*UploadKycResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadKycFile not implemented")
}
...
func RegisterUserFileStoreServer(s grpc.ServiceRegistrar, srv UserFileStoreServer) {
	// If the following call panics, it indicates UnimplementedUserFileStoreServer was
