...
const file_game_service_v1_game_proto_rawDesc = "" +
	...
	"\n" +
	"win_amount\x18\x0e \x01(\tR\twinAmount*_\n" +
	"\x15TaxReportRecordStatus\x12!\n" +
	"\x1dTaxReportRecordStatus_PENDING\x10\x00\x12#\n" +
	"\x1fTaxReportRecordStatus_CONFIRMED\x10\x012\xf0\x1c\n" +
	"\x04Game\x12k\n" +
	...
	"\x0eListUnpaidBets\x12*.api.game.service.v1.ListUnpaidBetsRequest\x1a+.api.game.service.v1.ListUnpaidBetsResponse\"\x00BO\n" +
...
var file_game_service_v1_game_proto_goTypes = []any{
	...
	(*ListUnpaidBetsResponse_UnpaidBet)(nil),                               // 89: api.game.service.v1.ListUnpaidBetsResponse.UnpaidBet
...
var file_game_service_v1_game_proto_depIdxs = []int32{
	...
	90, // 43: api.game.service.v1.GetResponsibleGamblingStatusRequest.operator_context:type_name -> api.common.OperatorContext
	88, // 44: api.game.service.v1.GetResponsibleGamblingStatusResponse.responsible_gambling_statuses:type_name -> api.game.service.v1.GetResponsibleGamblingStatusResponse.ResponsibleGamblingStatus
	91, // 45: api.game.service.v1.ListUnpaidBetsRequest.start_time:type_name -> google.protobuf.Timestamp
	91, // 46: api.game.service.v1.ListUnpaidBetsRequest.end_time:type_name -> google.protobuf.Timestamp
	90, // 47: api.game.service.v1.ListUnpaidBetsRequest.operator_context:type_name -> api.common.OperatorContext
	89, // 48: api.game.service.v1.ListUnpaidBetsResponse.unpaid_bets:type_name -> api.game.service.v1.ListUnpaidBetsResponse.UnpaidBet
	35, // 49: api.game.service.v1.PlayResponse.Data.transactions:type_name -> api.game.service.v1.Transactions
	39, // 50: api.game.service.v1.RollbackResponse.Data.transactions:type_name -> api.game.service.v1.RollbackTransactions
	91, // 51: api.game.service.v1.GetBetByIdResponse.Action.bet_time:type_name -> google.protobuf.Timestamp
	91, // 52: api.game.service.v1.GetBetByIdResponse.Action.settle_time:type_name -> google.protobuf.Timestamp
	91, // 53: api.game.service.v1.GetBetByIdResponse.Action.provider_timestamp:type_name -> google.protobuf.Timestamp
	91, // 54: api.game.service.v1.GetBetByIdResponse.Action.operator_timestamp:type_name -> google.protobuf.Timestamp
	91, // 55: api.game.service.v1.GetBetByIdResponse.Action.processed_at:type_name -> google.protobuf.Timestamp
	91, // 56: api.game.service.v1.GetBetByIdResponse.Action.created_at:type_name -> google.protobuf.Timestamp
	91, // 57: api.game.service.v1.GetBetByIdResponse.Action.updated_at:type_name -> google.protobuf.Timestamp
	91, // 58: api.game.service.v1.GetBetByIdResponse.Bet.created_at:type_name -> google.protobuf.Timestamp
	91, // 59: api.game.service.v1.GetBetByIdResponse.Bet.updated_at:type_name -> google.protobuf.Timestamp
	80, // 60: api.game.service.v1.GetBetByIdResponse.Bet.actions:type_name -> api.game.service.v1.GetBetByIdResponse.Action
	91, // 61: api.game.service.v1.GetDailyGameTransactionDataRequest.TimeRange.start_time:type_name -> google.protobuf.Timestamp
	91, // 62: api.game.service.v1.GetDailyGameTransactionDataRequest.TimeRange.end_time:type_name -> google.protobuf.Timestamp
	0,  // 63: api.game.service.v1.ListTaxReportsResponse.TaxReport.status:type_name -> api.game.service.v1.TaxReportRecordStatus
	91, // 64: api.game.service.v1.ListUnpaidBetsResponse.UnpaidBet.create_date_time:type_name -> google.protobuf.Timestamp
	91, // 65: api.game.service.v1.ListUnpaidBetsResponse.UnpaidBet.update_date_time:type_name -> google.protobuf.Timestamp
	2,  // 66: api.game.service.v1.Game.CreateOperator:input_type -> api.game.service.v1.CreateOperatorRequest
	4,  // 67: api.game.service.v1.Game.UpdateOperator:input_type -> api.game.service.v1.UpdateOperatorRequest
	6,  // 68: api.game.service.v1.Game.DeleteOperator:input_type -> api.game.service.v1.DeleteOperatorRequest
	10, // 69: api.game.service.v1.Game.ListProviders:input_type -> api.game.service.v1.ListProvidersRequest
	12, // 70: api.game.service.v1.Game.ListCategories:input_type -> api.game.service.v1.ListCategoriesRequest
	14, // 71: api.game.service.v1.Game.ListFeeGroups:input_type -> api.game.service.v1.ListFeeGroupsRequest
	16, // 72: api.game.service.v1.Game.ListTags:input_type -> api.game.service.v1.ListTagsRequest
	18, // 73: api.game.service.v1.Game.ListThemes:input_type -> api.game.service.v1.ListThemesRequest
	20, // 74: api.game.service.v1.Game.ListCurrencies:input_type -> api.game.service.v1.ListCurrenciesRequest
	22, // 75: api.game.service.v1.Game.ListGames:input_type -> api.game.service.v1.ListGamesRequest
	24, // 76: api.game.service.v1.Game.GetGame:input_type -> api.game.service.v1.GetGameRequest
	27, // 77: api.game.service.v1.Game.CreateSession:input_type -> api.game.service.v1.CreateSessionRequest
	30, // 78: api.game.service.v1.Game.Balance:input_type -> api.game.service.v1.BalanceRequest
	32, // 79: api.game.service.v1.Game.Play:input_type -> api.game.service.v1.PlayRequest
	36, // 80: api.game.service.v1.Game.Rollback:input_type -> api.game.service.v1.RollbackRequest
	40, // 81: api.game.service.v1.Game.ListBets:input_type -> api.game.service.v1.ListBetsRequest
	43, // 82: api.game.service.v1.Game.BackofficeListGames:input_type -> api.game.service.v1.BackofficeListGamesRequest
	45, // 83: api.game.service.v1.Game.UpdateGame:input_type -> api.game.service.v1.UpdateGameRequest
	47, // 84: api.game.service.v1.Game.UpdateProvider:input_type -> api.game.service.v1.UpdateProviderRequest
	49, // 85: api.game.service.v1.Game.GetBetById:input_type -> api.game.service.v1.GetBetByIdRequest
	51, // 86: api.game.service.v1.Game.GetBackofficeUserOverviewFromGame:input_type -> api.game.service.v1.GetBackofficeUserOverviewFromGameRequest
	55, // 87: api.game.service.v1.Game.ListProviderRates:input_type -> api.game.service.v1.ListProviderRatesRequest
	53, // 88: api.game.service.v1.Game.GetGameTransactionById:input_type -> api.game.service.v1.GetGameTransactionByIdRequest
	57, // 89: api.game.service.v1.Game.GetDailyGameTransactionData:input_type -> api.game.service.v1.GetDailyGameTransactionDataRequest
	59, // 90: api.game.service.v1.Game.ListProviderByIDs:input_type -> api.game.service.v1.ListProviderByIDsRequest
	61, // 91: api.game.service.v1.Game.GetTaxReportConfig:input_type -> api.game.service.v1.GetTaxReportConfigRequest
	63, // 92: api.game.service.v1.Game.UpdateTaxReportConfig:input_type -> api.game.service.v1.UpdateTaxReportConfigRequest
	65, // 93: api.game.service.v1.Game.ListTaxReports:input_type -> api.game.service.v1.ListTaxReportsRequest
	67, // 94: api.game.service.v1.Game.UpdateTaxReport:input_type -> api.game.service.v1.UpdateTaxReportRequest
	69, // 95: api.game.service.v1.Game.GetResponsibleGamblingStatus:input_type -> api.game.service.v1.GetResponsibleGamblingStatusRequest
	71, // 96: api.game.service.v1.Game.ListUnpaidBets:input_type -> api.game.service.v1.ListUnpaidBetsRequest
	...
	72, // 127: api.game.service.v1.Game.ListUnpaidBets:output_type -> api.game.service.v1.ListUnpaidBetsResponse
