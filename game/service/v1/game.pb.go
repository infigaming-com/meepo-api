...
type Transactions struct {
	...
	ProcessedAt   *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=processed_at,proto3" json:"processed_at,omitempty"`
...
func (x *Transactions) GetProcessedAt() *timestamppb.Timestamp {
	if x != nil {
...
const file_game_service_v1_game_proto_rawDesc = "" +
	...
	"settleTime\x12-\n" +
	"\x12provider_timestamp\x18\r \x01(\x03R\x11providerTimestamp\"\xb4\x01\n" +
	"\fTransactions\x12\x16\n" +
	"\x06txn_id\x18\x01 \x01(\tR\x06txn_id\x12(\n" +
	"\x0foperator_txn_id\x18\x02 \x01(\tR\x0foperator_txn_id\x12>\n" +
	"\fprocessed_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\fprocessed_at\x12\"\n" +
...
var file_game_service_v1_game_proto_depIdxs = []int32{
	...
	67, // 9: api.game.service.v1.Transactions.processed_at:type_name -> google.protobuf.Timestamp
	36, // 10: api.game.service.v1.RollbackRequest.actions:type_name -> api.game.service.v1.RollbackAction
	59, // 11: api.game.service.v1.RollbackResponse.data:type_name -> api.game.service.v1.RollbackResponse.Data
	67, // 12: api.game.service.v1.ListBetsRequest.start_time:type_name -> google.protobuf.Timestamp
	67, // 13: api.game.service.v1.ListBetsRequest.end_time:type_name -> google.protobuf.Timestamp
