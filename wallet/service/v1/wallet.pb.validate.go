...
// Validate checks the field values on GetExchangeRatesResponse_ExchangeRate
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *GetExchangeRatesResponse_ExchangeRate) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetExchangeRatesResponse_ExchangeRate
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GetExchangeRatesResponse_ExchangeRateMultiError, or nil if none found.
func (m *GetExchangeRatesResponse_ExchangeRate) ValidateAll() error {
	return m.validate(true)
}

func (m *GetExchangeRatesResponse_ExchangeRate) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetExchangeRatesResponse_ExchangeRateMultiError(errors)
	}

	return nil
}

// GetExchangeRatesResponse_ExchangeRateMultiError is an error wrapping
// multiple validation errors returned by
// GetExchangeRatesResponse_ExchangeRate.ValidateAll() if the designated
// constraints aren't met.
type GetExchangeRatesResponse_ExchangeRateMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetExchangeRatesResponse_ExchangeRateMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetExchangeRatesResponse_ExchangeRateMultiError) AllErrors() []error { return m }

// GetExchangeRatesResponse_ExchangeRateValidationError is the validation error
// returned by GetExchangeRatesResponse_ExchangeRate.Validate if the
// designated constraints aren't met.
type GetExchangeRatesResponse_ExchangeRateValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetExchangeRatesResponse_ExchangeRateValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetExchangeRatesResponse_ExchangeRateValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetExchangeRatesResponse_ExchangeRateValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetExchangeRatesResponse_ExchangeRateValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetExchangeRatesResponse_ExchangeRateValidationError) ErrorName() string {
	return "GetExchangeRatesResponse_ExchangeRateValidationError"
}

// Error satisfies the builtin error interface
func (e GetExchangeRatesResponse_ExchangeRateValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetExchangeRatesResponse_ExchangeRate.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetExchangeRatesResponse_ExchangeRateValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetExchangeRatesResponse_ExchangeRateValidationError{}
