...
const file_wallet_service_v1_wallet_proto_rawDesc = "" +
	...
	"\x0eprovider_bonus\x18\x04 \x01(\x03R\rproviderBonus\"\x8a\x01\n" +
	"\rCreditRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04cash\x18\x02 \x01(\x03R\x04cash\x12%\n" +
	"\x0eoperator_bonus\x18\x03 \x01(\x03R\roperatorBonus\x12%\n" +
	"\x0eprovider_bonus\x18\x04 \x01(\x03R\rproviderBonus\"\x99\x01\n" +
	"\x0eCreditResponse\x12%\n" +
	"\x0etransaction_id\x18\x01 \x01(\tR\rtransactionId\x12\x12\n" +
	"\x04cash\x18\x02 \x01(\x03R\x04cash\x12%\n" +
	"\x0eoperator_bonus\x18\x03 \x01(\x03R\roperatorBonus\x12%\n" +
	"\x0eprovider_bonus\x18\x04 \x01(\x03R\rproviderBonus\"\x89\x01\n" +
	"\fDebitRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04cash\x18\x02 \x01(\x03R\x04cash\x12%\n" +
	"\x0eoperator_bonus\x18\x03 \x01(\x03R\roperatorBonus\x12%\n" +
	"\x0eprovider_bonus\x18\x04 \x01(\x03R\rproviderBonus\"\x98\x01\n" +
	"\rDebitResponse\x12%\n" +
	"\x0etransaction_id\x18\x01 \x01(\tR\rtransactionId\x12\x12\n" +
	"\x04cash\x18\x02 \x01(\x03R\x04cash\x12%\n" +
	"\x0eoperator_bonus\x18\x03 \x01(\x03R\roperatorBonus\x12%\n" +
	"\x0eprovider_bonus\x18\x04 \x01(\x03R\rproviderBonus2\xd2\x06\n" +
	"\x06Wallet\x12Z\n" +
	...
	"\x0fGetUserBalances\x12-.api.wallet.service.v1.GetUserBalancesRequest\x1a..api.wallet.service.v1.GetUserBalancesResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/v1/wallet/balance/{user_id}\x12W\n" +
