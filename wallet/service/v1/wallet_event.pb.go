...
const file_wallet_service_v1_wallet_event_proto_rawDesc = "" +
	"\n" +
	"$wallet/service/v1/wallet_event.proto\x12\x15api.wallet.service.v1\"C\n" +
...
var file_wallet_service_v1_wallet_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
