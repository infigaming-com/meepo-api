...
// Validate checks the field values on VipUpdateEvent with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *VipUpdateEvent) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on VipUpdateEvent with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in VipUpdateEventMultiError,
// or nil if none found.
func (m *VipUpdateEvent) ValidateAll() error {
	return m.validate(true)
}

func (m *VipUpdateEvent) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, VipUpdateEventValidationError{
		...
		if err := v.Validate(); err != nil {
			return VipUpdateEventValidationError{
				field:  "OperatorContext",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	// no validation rules for OldVipLevel

	// no validation rules for NewVipLevel

	// no validation rules for UpdatedAt

	if len(errors) > 0 {
		return VipUpdateEventMultiError(errors)
	}

	return nil
}

// VipUpdateEventMultiError is an error wrapping multiple validation errors
// returned by VipUpdateEvent.ValidateAll() if the designated constraints
// aren't met.
type VipUpdateEventMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m VipUpdateEventMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m VipUpdateEventMultiError) AllErrors() []error { return m }

// VipUpdateEventValidationError is the validation error returned by
// VipUpdateEvent.Validate if the designated constraints aren't met.
type VipUpdateEventValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e VipUpdateEventValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e VipUpdateEventValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e VipUpdateEventValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e VipUpdateEventValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e VipUpdateEventValidationError) ErrorName() string { return "VipUpdateEventValidationError" }

// Error satisfies the builtin error interface
func (e VipUpdateEventValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = VipUpdateEventValidationError{}
