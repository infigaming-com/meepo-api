...
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SendWebPushRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SendWebPushRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SendWebPushRequestMultiError, or nil if none found.
func (m *SendWebPushRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SendWebPushRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SendWebPushRequestMultiError(errors)
	}

	return nil
}

// SendWebPushRequestMultiError is an error wrapping multiple validation errors
// returned by SendWebPushRequest.ValidateAll() if the designated constraints
// aren't met.
type SendWebPushRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SendWebPushRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SendWebPushRequestMultiError) AllErrors() []error { return m }

// SendWebPushRequestValidationError is the validation error returned by
// SendWebPushRequest.Validate if the designated constraints aren't met.
type SendWebPushRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SendWebPushRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SendWebPushRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SendWebPushRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SendWebPushRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SendWebPushRequestValidationError) ErrorName() string {
	return "SendWebPushRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SendWebPushRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSendWebPushRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SendWebPushRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SendWebPushRequestValidationError{}

// Validate checks the field values on SendWebPushResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SendWebPushResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SendWebPushResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SendWebPushResponseMultiError, or nil if none found.
func (m *SendWebPushResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *SendWebPushResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SendWebPushResponseMultiError(errors)
	}

	return nil
}

// SendWebPushResponseMultiError is an error wrapping multiple validation
// errors returned by SendWebPushResponse.ValidateAll() if the designated
// constraints aren't met.
type SendWebPushResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SendWebPushResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SendWebPushResponseMultiError) AllErrors() []error { return m }

// SendWebPushResponseValidationError is the validation error returned by
// SendWebPushResponse.Validate if the designated constraints aren't met.
type SendWebPushResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SendWebPushResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SendWebPushResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SendWebPushResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SendWebPushResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SendWebPushResponseValidationError) ErrorName() string {
	return "SendWebPushResponseValidationError"
}

// Error satisfies the builtin error interface
func (e SendWebPushResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSendWebPushResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SendWebPushResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SendWebPushResponseValidationError{}
