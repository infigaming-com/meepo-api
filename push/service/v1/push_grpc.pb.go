...
const (
	...
	Push_GetWebPushConfig_FullMethodName        = "/api.push.service.v1.Push/GetWebPushConfig"
...
type PushClient interface {
	...
	// Web Push APIs
	// SendWebPush is gRPC-only (called internally by other services).
	SendWebPush(ctx context.Context, in *SendWebPushRequest, opts ...grpc.CallOption) (*SendWebPushResponse, error)
	// GetWebPushConfig returns the Firebase JS SDK configuration for the current
	...
	GetWebPushConfig(ctx context.Context, in *GetWebPushConfigRequest, opts ...grpc.CallOption) (*GetWebPushConfigResponse, error)
...
func (c *pushClient) GetWebPushConfig(ctx context.Context, in *GetWebPushConfigRequest, opts ...grpc.CallOption) (*GetWebPushConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWebPushConfigResponse)
	err := c.cc.Invoke(ctx, Push_GetWebPushConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPushServer) GetWebPushConfig(context.Context, *GetWebPushConfigRequest) (*GetWebPushConfigResponse, error) {
...
func _Push_GetWebPushConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWebPushConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushServer).GetWebPushConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Push_GetWebPushConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushServer).GetWebPushConfig(ctx, req.(*GetWebPushConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Push_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Push_GetWebPushConfig_Handler,
		},
		{
