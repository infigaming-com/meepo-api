...
const (
	...
	OTPTemplateType_OTP_TEMPLATE_TYPE_PHONE_VERIFICATION OTPTemplateType = 5
)
...
var (
	OTPTemplateType_name = map[int32]string{
		...
		5: "OTP_TEMPLATE_TYPE_PHONE_VERIFICATION",
	}
	OTPTemplateType_value = map[string]int32{
		...
		"OTP_TEMPLATE_TYPE_PHONE_VERIFICATION": 5,
	}
)
...
const file_push_service_v1_push_otp_proto_rawDesc = "" +
	...
	",OTP_SEND_CHANNEL_STRATEGY_WHATSAPP_SMS_VOICE\x10\x03*\xf9\x01\n" +
	...
	"$OTP_TEMPLATE_TYPE_WITHDRAWAL_CONFIRM\x10\x04\x12(\n" +
	"$OTP_TEMPLATE_TYPE_PHONE_VERIFICATION\x10\x05*\xea\x01\n" +
