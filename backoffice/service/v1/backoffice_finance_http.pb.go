...
const OperationBackofficeFinanceDeleteAdjustment = "/api.backoffice.service.v1.BackofficeFinance/DeleteAdjustment"
...
const OperationBackofficeFinanceListPaymentChannelFees = "/api.backoffice.service.v1.BackofficeFinance/ListPaymentChannelFees"
const OperationBackofficeFinanceListRevenueShareRateConfigs = "/api.backoffice.service.v1.BackofficeFinance/ListRevenueShareRateConfigs"
...
const OperationBackofficeFinancePayInvoice = "/api.backoffice.service.v1.BackofficeFinance/PayInvoice"
const OperationBackofficeFinanceSendInvoices = "/api.backoffice.service.v1.BackofficeFinance/SendInvoices"
const OperationBackofficeFinanceUpdateAdjustment = "/api.backoffice.service.v1.BackofficeFinance/UpdateAdjustment"
...
func RegisterBackofficeFinanceHTTPServer(s *http.Server, srv BackofficeFinanceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/backoffice/finance/invoices/list", _BackofficeFinance_ListInvoices0_HTTP_Handler(srv))
	...
	r.POST("/v1/backoffice/finance/adjustment-configs/create", _BackofficeFinance_CreateAdjustmentConfig0_HTTP_Handler(srv))
	...
	r.POST("/v1/backoffice/finance/adjustment/delete", _BackofficeFinance_DeleteAdjustment0_HTTP_Handler(srv))
	r.POST("/v1/backoffice/finance/adjustments/update", _BackofficeFinance_UpdateAdjustment0_HTTP_Handler(srv))
	r.POST("/v1/backoffice/finance/invoices/send", _BackofficeFinance_SendInvoices0_HTTP_Handler(srv))
	r.POST("/v1/backoffice/finance/invoice/pay", _BackofficeFinance_PayInvoice0_HTTP_Handler(srv))
	r.POST("/v1/backoffice/finance/invoices/summary", _BackofficeFinance_GetInvoiceSummary0_HTTP_Handler(srv))
	r.POST("/v1/backoffice/finance/balance/summary", _BackofficeFinance_GetBalanceSummary0_HTTP_Handler(srv))
	r.POST("/v1/backoffice/finance/balances/summary", _BackofficeFinance_GetBalancesSummary0_HTTP_Handler(srv))
	...
	r.POST("/v1/backoffice/finance/payment-channel-fees/list", _BackofficeFinance_ListPaymentChannelFees0_HTTP_Handler(srv))
}
...
func _BackofficeFinance_ListInvoices0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceListInvoices)
...
func _BackofficeFinance_CreateAdjustmentConfig0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in CreateAdjustmentConfigRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceCreateAdjustmentConfig)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.CreateAdjustmentConfig(ctx, req.(*CreateAdjustmentConfigRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*CreateAdjustmentConfigResponse)
		return ctx.Result(200, reply)
	}
}
...
func _BackofficeFinance_DeleteAdjustment0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DeleteAdjustmentRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceDeleteAdjustment)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.DeleteAdjustment(ctx, req.(*DeleteAdjustmentRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*DeleteAdjustmentResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_UpdateAdjustment0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UpdateAdjustmentRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceUpdateAdjustment)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UpdateAdjustment(ctx, req.(*UpdateAdjustmentRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UpdateAdjustmentResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_SendInvoices0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in SendInvoicesRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceSendInvoices)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.SendInvoices(ctx, req.(*SendInvoicesRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*SendInvoicesResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_PayInvoice0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationBackofficeFinancePayInvoice)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.PayInvoice(ctx, req.(*PayInvoiceRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*PayInvoiceResponse)
		return ctx.Result(200, reply)
	}
}
...
func _BackofficeFinance_GetBalanceSummary0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetBalanceSummaryRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceGetBalanceSummary)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetBalanceSummary(ctx, req.(*GetBalanceSummaryRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetBalanceSummaryResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_GetBalancesSummary0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetBalancesSummaryRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceGetBalancesSummary)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetBalancesSummary(ctx, req.(*GetBalancesSummaryRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetBalancesSummaryResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_ListBillingPeriods0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListBillingPeriodsRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceListBillingPeriods)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListBillingPeriods(ctx, req.(*ListBillingPeriodsRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListBillingPeriodsResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_ListBalanceMonthlyRevenueShares0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListBalanceMonthlyRevenueSharesRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceListBalanceMonthlyRevenueShares)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListBalanceMonthlyRevenueShares(ctx, req.(*ListBalanceMonthlyRevenueSharesRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListBalanceMonthlyRevenueSharesResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_ListBalancesSummary0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListBalancesSummaryRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceListBalancesSummary)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListBalancesSummary(ctx, req.(*ListBalancesSummaryRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListBalancesSummaryResponse)
		return ctx.Result(200, reply)
	}
}
...
func _BackofficeFinance_ListRevenueShareRateConfigs0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListRevenueShareRateConfigsRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceListRevenueShareRateConfigs)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListRevenueShareRateConfigs(ctx, req.(*ListRevenueShareRateConfigsRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListRevenueShareRateConfigsResponse)
		return ctx.Result(200, reply)
	}
}

func _BackofficeFinance_ListPaymentChannelFees0_HTTP_Handler(srv BackofficeFinanceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListPaymentChannelFeesRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficeFinanceListPaymentChannelFees)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListPaymentChannelFees(ctx, req.(*ListPaymentChannelFeesRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListPaymentChannelFeesResponse)
		return ctx.Result(200, reply)
	}
}
...
type BackofficeFinanceHTTPClient interface {
	...
	DeleteAdjustment(ctx context.Context, req *DeleteAdjustmentRequest, opts ...http.CallOption) (rsp *DeleteAdjustmentResponse, err error)
	...
	ListPaymentChannelFees(ctx context.Context, req *ListPaymentChannelFeesRequest, opts ...http.CallOption) (rsp *ListPaymentChannelFeesResponse, err error)
	ListRevenueShareRateConfigs(ctx context.Context, req *ListRevenueShareRateConfigsRequest, opts ...http.CallOption) (rsp *ListRevenueShareRateConfigsResponse, err error)
	...
	PayInvoice(ctx context.Context, req *PayInvoiceRequest, opts ...http.CallOption) (rsp *PayInvoiceResponse, err error)
	SendInvoices(ctx context.Context, req *SendInvoicesRequest, opts ...http.CallOption) (rsp *SendInvoicesResponse, err error)
	UpdateAdjustment(ctx context.Context, req *UpdateAdjustmentRequest, opts ...http.CallOption) (rsp *UpdateAdjustmentResponse, err error)
...
func (c *BackofficeFinanceHTTPClientImpl) CreateAdjustmentConfig(ctx context.Context, in *CreateAdjustmentConfigRequest, opts ...http.CallOption) (*CreateAdjustmentConfigResponse, error) {
	var out CreateAdjustmentConfigResponse
	pattern := "/v1/backoffice/finance/adjustment-configs/create"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceCreateAdjustmentConfig))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) DeleteAdjustment(ctx context.Context, in *DeleteAdjustmentRequest, opts ...http.CallOption) (*DeleteAdjustmentResponse, error) {
	var out DeleteAdjustmentResponse
	pattern := "/v1/backoffice/finance/adjustment/delete"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceDeleteAdjustment))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) GetBalanceSummary(ctx context.Context, in *GetBalanceSummaryRequest, opts ...http.CallOption) (*GetBalanceSummaryResponse, error) {
	var out GetBalanceSummaryResponse
	pattern := "/v1/backoffice/finance/balance/summary"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceGetBalanceSummary))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) GetBalancesSummary(ctx context.Context, in *GetBalancesSummaryRequest, opts ...http.CallOption) (*GetBalancesSummaryResponse, error) {
	var out GetBalancesSummaryResponse
	pattern := "/v1/backoffice/finance/balances/summary"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceGetBalancesSummary))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) ListBalanceMonthlyRevenueShares(ctx context.Context, in *ListBalanceMonthlyRevenueSharesRequest, opts ...http.CallOption) (*ListBalanceMonthlyRevenueSharesResponse, error) {
	var out ListBalanceMonthlyRevenueSharesResponse
	pattern := "/v1/backoffice/finance/balance/monthly-revenue-shares/list"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceListBalanceMonthlyRevenueShares))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) ListBalancesSummary(ctx context.Context, in *ListBalancesSummaryRequest, opts ...http.CallOption) (*ListBalancesSummaryResponse, error) {
	var out ListBalancesSummaryResponse
	pattern := "/v1/backoffice/finance/balances/summary/list"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceListBalancesSummary))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) ListBillingPeriods(ctx context.Context, in *ListBillingPeriodsRequest, opts ...http.CallOption) (*ListBillingPeriodsResponse, error) {
	var out ListBillingPeriodsResponse
...
func (c *BackofficeFinanceHTTPClientImpl) ListInvoices(ctx context.Context, in *ListInvoicesRequest, opts ...http.CallOption) (*ListInvoicesResponse, error) {
	var out ListInvoicesResponse
	pattern := "/v1/backoffice/finance/invoices/list"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceListInvoices))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) ListPaymentChannelFees(ctx context.Context, in *ListPaymentChannelFeesRequest, opts ...http.CallOption) (*ListPaymentChannelFeesResponse, error) {
	var out ListPaymentChannelFeesResponse
	pattern := "/v1/backoffice/finance/payment-channel-fees/list"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceListPaymentChannelFees))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) ListRevenueShareRateConfigs(ctx context.Context, in *ListRevenueShareRateConfigsRequest, opts ...http.CallOption) (*ListRevenueShareRateConfigsResponse, error) {
	var out ListRevenueShareRateConfigsResponse
	pattern := "/v1/backoffice/finance/revenue-share-rate-configs/list"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceListRevenueShareRateConfigs))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) PayInvoice(ctx context.Context, in *PayInvoiceRequest, opts ...http.CallOption) (*PayInvoiceResponse, error) {
	var out PayInvoiceResponse
	pattern := "/v1/backoffice/finance/invoice/pay"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinancePayInvoice))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) SendInvoices(ctx context.Context, in *SendInvoicesRequest, opts ...http.CallOption) (*SendInvoicesResponse, error) {
	var out SendInvoicesResponse
	pattern := "/v1/backoffice/finance/invoices/send"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceSendInvoices))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficeFinanceHTTPClientImpl) UpdateAdjustment(ctx context.Context, in *UpdateAdjustmentRequest, opts ...http.CallOption) (*UpdateAdjustmentResponse, error) {
	var out UpdateAdjustmentResponse
	pattern := "/v1/backoffice/finance/adjustments/update"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficeFinanceUpdateAdjustment))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
