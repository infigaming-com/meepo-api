...
func (SubAccountTransferRequest_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_backoffice_service_v1_backoffice_wallet_proto_enumTypes[0].Descriptor()
}

func (SubAccountTransferRequest_Direction) Type() protoreflect.EnumType {
	return &file_backoffice_service_v1_backoffice_wallet_proto_enumTypes[0]
}
...
func (SubAccountTransferRequest_Direction) EnumDescriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{34, 0}
}
...
type ListCompanyBalancesRequest struct {
	state                  protoimpl.MessageState         `protogen:"open.v1"`
	OperatorContextFilters *common.OperatorContextFilters `protobuf:"bytes,1,opt,name=operator_context_filters,json=operatorContextFilters,proto3" json:"operator_context_filters,omitempty"`
	Currencies             []string                       `protobuf:"bytes,2,rep,name=currencies,proto3" json:"currencies,omitempty"`
	// Default 1
...
func (x *ListCompanyBalancesRequest) Reset() {
	*x = ListCompanyBalancesRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListCompanyBalancesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListCompanyBalancesRequest) ProtoMessage() {}

func (x *ListCompanyBalancesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListCompanyBalancesRequest.ProtoReflect.Descriptor instead.
func (*ListCompanyBalancesRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{15}
}

func (x *ListCompanyBalancesRequest) GetOperatorContextFilters() *common.OperatorContextFilters {
	if x != nil {
		return x.OperatorContextFilters
	}
	return nil
...
func (x *ListCompanyBalancesRequest) GetCurrencies() []string {
	if x != nil {
		return x.Currencies
	}
	return nil
...
func (x *ListCompanyBalancesRequest) GetPage() int32 {
	if x != nil && x.Page != nil {
		return *x.Page
	}
	return 0
...
func (x *ListCompanyBalancesRequest) GetPageSize() int32 {
	if x != nil && x.PageSize != nil {
		return *x.PageSize
	}
	return 0
...
type EnableOperatorSubAccountRequest struct {
	state           protoimpl.MessageState  `protogen:"open.v1"`
	OperatorContext *common.OperatorContext `protobuf:"bytes,1,opt,name=operator_context,json=operatorContext,proto3" json:"operator_context,omitempty"`
	// e.g. "polymarket"; valid set is defined in wallet-service sub_account_rules.go
...
type SubAccountTransferRequest struct {
	...
	CashAmount string                              `protobuf:"bytes,4,opt,name=cash_amount,json=cashAmount,proto3" json:"cash_amount,omitempty"`
	Direction  SubAccountTransferRequest_Direction `protobuf:"varint,5,opt,name=direction,proto3,enum=api.backoffice.service.v1.SubAccountTransferRequest_Direction" json:"direction,omitempty"`
	// idempotency key — caller-supplied; reusing the same value returns the prior result
	ExternalTransactionId int64  `protobuf:"varint,6,opt,name=external_transaction_id,json=externalTransactionId,proto3" json:"external_transaction_id,omitempty"`
...
type OperatorBalanceTransaction struct {
	...
	ExternalTransactionId int64                   `protobuf:"varint,16,opt,name=external_transaction_id,json=externalTransactionId,proto3" json:"external_transaction_id,omitempty"`
	RelatedTransactionId  int64                   `protobuf:"varint,17,opt,name=related_transaction_id,json=relatedTransactionId,proto3" json:"related_transaction_id,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type SetUserSwapTemplateRequest struct {
	state                 protoimpl.MessageState  `protogen:"open.v1"`
	TargetOperatorContext *common.OperatorContext `protobuf:"bytes,1,opt,name=target_operator_context,json=targetOperatorContext,proto3" json:"target_operator_context,omitempty"`
	// Operator-level toggle. When true, the operator inherits the parent's template.
	FollowParent  *bool              `protobuf:"varint,2,opt,name=follow_parent,json=followParent,proto3,oneof" json:"follow_parent,omitempty"`
	Config        *v1.UserSwapConfig `protobuf:"bytes,3,opt,name=config,proto3" json:"config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetUserSwapTemplateRequest) GetConfig() *v1.UserSwapConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
type PushBetLimitsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional currency filter. Empty = every currency configured on System.
	Currencies    []string `protobuf:"bytes,1,rep,name=currencies,proto3" json:"currencies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PullBetLimitsRequest struct {
	state                 protoimpl.MessageState  `protogen:"open.v1"`
	TargetOperatorContext *common.OperatorContext `protobuf:"bytes,1,opt,name=target_operator_context,json=targetOperatorContext,proto3" json:"target_operator_context,omitempty"`
	// Optional currency filter. Empty = every currency the target already has.
	Currencies    []string `protobuf:"bytes,2,rep,name=currencies,proto3" json:"currencies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*DeleteWalletResponsibleGamblingConfigRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{57}
}
...
func (*ListWalletResponsibleGamblingConfigsRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{58}
}
...
func (x *ExportCustomerRecordsRequest) Reset() {
	*x = ExportCustomerRecordsRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExportCustomerRecordsRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{60}
}
...
func (x *SetFICAThresholdConfigRequest) Reset() {
	*x = SetFICAThresholdConfigRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetFICAThresholdConfigRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{61}
}
...
func (*CreatePromoCodeCampaignRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{69}
}
...
func (*UpdatePromoCodeCampaignRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{70}
}
...
func (*UpdatePromoCodeCampaignStatusRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{71}
}
...
func (x *ListPromoCodeCampaignsRequest) Reset() {
	*x = ListPromoCodeCampaignsRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[72]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPromoCodeCampaignsRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{72}
}
...
func (x *ListPromoCodeCampaignDetailsRequest) Reset() {
	*x = ListPromoCodeCampaignDetailsRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[73]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPromoCodeCampaignDetailsRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{73}
}
...
func (x *GenerateOneTimePromoCodesRequest) Reset() {
	*x = GenerateOneTimePromoCodesRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[74]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateOneTimePromoCodesRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{74}
}
...
func (x *GenerateUniversalPromoCodesRequest) Reset() {
	*x = GenerateUniversalPromoCodesRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateUniversalPromoCodesRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{75}
}
...
func (x *ListUniversalCodeUsagesRequest) Reset() {
	*x = ListUniversalCodeUsagesRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[76]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListUniversalCodeUsagesRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{76}
}
...
func (x *ExportPromoCodesRequest) Reset() {
	*x = ExportPromoCodesRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExportPromoCodesRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{77}
}
...
func (x *ManualAdjustCreditTurnoverFieldRequest) Reset() {
	*x = ManualAdjustCreditTurnoverFieldRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ManualAdjustCreditTurnoverFieldRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{78}
}
...
// Backoffice request to set the app download reward config for a target operator.
// Initiator operator context is injected from the backoffice auth middleware.
type SetAppDownloadRewardConfigRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The target operator whose config is being set.
	TargetOperatorContext *common.OperatorContext `protobuf:"bytes,1,opt,name=target_operator_context,json=targetOperatorContext,proto3" json:"target_operator_context,omitempty"`
	...
	Configs       []*v1.AppDownloadRewardConfigItem `protobuf:"bytes,3,rep,name=configs,proto3" json:"configs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetAppDownloadRewardConfigRequest) Reset() {
	*x = SetAppDownloadRewardConfigRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[79]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetAppDownloadRewardConfigRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{79}
}
...
func (x *SetAppDownloadRewardConfigRequest) GetConfigs() []*v1.AppDownloadRewardConfigItem {
	if x != nil {
		return x.Configs
	}
	return nil
...
// Backoffice request to get the app download reward config for a target operator.
type GetAppDownloadRewardConfigRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The target operator whose config is being queried.
	TargetOperatorContext *common.OperatorContext `protobuf:"bytes,1,opt,name=target_operator_context,json=targetOperatorContext,proto3" json:"target_operator_context,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *GetAppDownloadRewardConfigRequest) Reset() {
	*x = GetAppDownloadRewardConfigRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[80]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAppDownloadRewardConfigRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{80}
}
...
func (x *ListOperatorWithdrawableAmountsRequest) Reset() {
	*x = ListOperatorWithdrawableAmountsRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[81]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListOperatorWithdrawableAmountsRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{81}
}
...
func (x *ListOperatorWithdrawableAmountsRequest) GetTargetOperatorContext() *common.OperatorContext {
	if x != nil {
		return x.TargetOperatorContext
	}
	return nil
...
type BOGetOperatorWithdrawableAmountRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Target operator to query; initiator's permission is validated against this
	TargetOperatorContext *common.OperatorContext `protobuf:"bytes,1,opt,name=target_operator_context,json=targetOperatorContext,proto3" json:"target_operator_context,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *BOGetOperatorWithdrawableAmountRequest) Reset() {
	*x = BOGetOperatorWithdrawableAmountRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BOGetOperatorWithdrawableAmountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*BOGetOperatorWithdrawableAmountRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{82}
}
...
type BOListUserFreeRewardsRequest struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	UserId int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
...
func (x *BOListUserFreeRewardsRequest) Reset() {
	*x = BOListUserFreeRewardsRequest{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[83]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BOListUserFreeRewardsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*BOListUserFreeRewardsRequest) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_wallet_proto_rawDescGZIP(), []int{83}
}
...
func (x *BOListUserFreeRewardsRequest) GetTypes() []string {
	if x != nil {
		return x.Types
	}
	return nil
...
func (x *BOListUserFreeRewardsRequest) GetStatuses() []string {
	if x != nil {
		return x.Statuses
	}
	return nil
...
func (x *BOListUserFreeRewardsRequest) GetSourceTypes() []string {
	if x != nil {
...
func (x *BOListUserFreeRewardsRequest) GetExpiringSoon() bool {
...
func (x *BOListUserFreeRewardsRequest) GetPage() int32 {
	if x != nil && x.Page != nil {
		return *x.Page
	}
	return 0
...
func (x *BOListUserFreeRewardsRequest) GetPageSize() int32 {
	if x != nil && x.PageSize != nil {
		return *x.PageSize
	}
	return 0
...
func (x *GetWalletCreditsResponse_Credit) Reset() {
	*x = GetWalletCreditsResponse_Credit{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[84]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ListWalletBalanceTransactionsResponse_BalanceTransaction) Reset() {
	*x = ListWalletBalanceTransactionsResponse_BalanceTransaction{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[85]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GetWalletCreditTransactionsResponse_CreditTransaction) Reset() {
	*x = GetWalletCreditTransactionsResponse_CreditTransaction{}
	mi := &file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[86]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_backoffice_service_v1_backoffice_wallet_proto_rawDesc = "" +
	...
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\xd3\x03\n" +
	...
	"\vcash_amount\x18\x04 \x01(\tR\n" +
	"cashAmount\x12\\\n" +
	"\tdirection\x18\x05 \x01(\x0e2>.api.backoffice.service.v1.SubAccountTransferRequest.DirectionR\tdirection\x126\n" +
	"\x17external_transaction_id\x18\x06 \x01(\x03R\x15externalTransactionId\x12\x12\n" +
	"\x04memo\x18\a \x01(\tR\x04memo\"d\n" +
	"\tDirection\x12\x19\n" +
	...
	"\x10sub_account_cash\x18\x04 \x01(\tR\x0esubAccountCash\"\xb8\x02\n" +
	...
	"\x17external_transaction_id\x18\x10 \x01(\x03R\x15externalTransactionId\x124\n" +
	"\x16related_transaction_id\x18\x11 \x01(\x03R\x14relatedTransactionId\"\xcb\x01\n" +
	...
	"\x17target_operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x15targetOperatorContext\x12\x1a\n" +
	"\bcurrency\x18\x02 \x01(\tR\bcurrency\"\x8a\x01\n" +
	"\x19SetUserSwapEnabledRequest\x12S\n" +
	"\x17target_operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x15targetOperatorContext\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\"\xec\x01\n" +
	"\x1aSetUserSwapTemplateRequest\x12S\n" +
	"\x17target_operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x15targetOperatorContext\x12(\n" +
	"\rfollow_parent\x18\x02 \x01(\bH\x00R\ffollowParent\x88\x01\x01\x12=\n" +
	"\x06config\x18\x03 \x01(\v2%.api.wallet.service.v1.UserSwapConfigR\x06configB\x10\n" +
	"\x0e_follow_parent\"o\n" +
	"\x18GetUserSwapConfigRequest\x12S\n" +
	...
	"\x18operator_currency_config\x18\x02 \x01(\v2-.api.wallet.service.v1.OperatorCurrencyConfigR\x16operatorCurrencyConfig\"6\n" +
	"\x14PushBetLimitsRequest\x12\x1e\n" +
	"\n" +
	"currencies\x18\x01 \x03(\tR\n" +
	"currencies\"\x8b\x01\n" +
	"\x14PullBetLimitsRequest\x12S\n" +
	"\x17target_operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x15targetOperatorContext\x12\x1e\n" +
	"\n" +
	"currencies\x18\x02 \x03(\tR\n" +
	"currencies\"\xba\x01\n" +
	...
	"\n" +
	"_page_size\"\x9b\x01\n" +
	" GenerateOneTimePromoCodesRequest\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\x03R\n" +
	"campaignId\x12\x1f\n" +
	...
	"\"GenerateUniversalPromoCodesRequest\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\x03R\n" +
	"campaignId\x12\x14\n" +
	...
	"\x05value\x18\x06 \x01(\tR\x05value\"\x82\x02\n" +
	"!SetAppDownloadRewardConfigRequest\x12S\n" +
	"\x17target_operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x15targetOperatorContext\x12(\n" +
	"\rfollow_parent\x18\x02 \x01(\bH\x00R\ffollowParent\x88\x01\x01\x12L\n" +
	...
	"_page_sizeB\r\n" +
	"\v_pagination\"}\n" +
	"&BOGetOperatorWithdrawableAmountRequest\x12S\n" +
	"\x17target_operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x15targetOperatorContext\"\x9a\x02\n" +
	"\x1cBOListUserFreeRewardsRequest\x12\x17\n" +
	...
	"\x14ListOperatorBalances\x126.api.backoffice.service.v1.ListOperatorBalancesRequest\x1a9.api.wallet.service.v1.ListBottomOperatorBalancesResponse\"7\x82\xd3\xe4\x93\x021:\x01*\",/v1/backoffice/wallet/operator/balances/list\x12\xc0\x01\n" +
	"\x13ListCompanyBalances\x125.api.backoffice.service.v1.ListCompanyBalancesRequest\x1a:.api.wallet.service.v1.ListCompanyOperatorBalancesResponse\"6\x82\xd3\xe4\x93\x020:\x01*\"+/v1/backoffice/wallet/company/balances/list\x12\xb0\x01\n" +
	...
	"\x15OperatorBalanceAdjust\x127.api.backoffice.service.v1.OperatorBalanceAdjustRequest\x1a8.api.backoffice.service.v1.OperatorBalanceAdjustResponse\"8\x82\xd3\xe4\x93\x022:\x01*\"-/v1/backoffice/wallet/operator/balance-adjust\x12\xd1\x01\n" +
	"\x18EnableOperatorSubAccount\x12:.api.backoffice.service.v1.EnableOperatorSubAccountRequest\x1a;.api.backoffice.service.v1.EnableOperatorSubAccountResponse\"<\x82\xd3\xe4\x93\x026:\x01*\"1/v1/backoffice/wallet/operator/sub-account/enable\x12\xd5\x01\n" +
	"\x19DisableOperatorSubAccount\x12;.api.backoffice.service.v1.DisableOperatorSubAccountRequest\x1a<.api.backoffice.service.v1.DisableOperatorSubAccountResponse\"=\x82\xd3\xe4\x93\x027:\x01*\"2/v1/backoffice/wallet/operator/sub-account/disable\x12\xc1\x01\n" +
	...
	"\x16GetDepositRewardConfig\x128.api.backoffice.service.v1.GetDepositRewardConfigRequest\x1a5.api.wallet.service.v1.GetDepositRewardConfigResponse\":\x82\xd3\xe4\x93\x024:\x01*\"//v1/backoffice/wallet/deposit-reward/config/get\x12\xd6\x01\n" +
	"\x1aSetAppDownloadRewardConfig\x12<.api.backoffice.service.v1.SetAppDownloadRewardConfigRequest\x1a9.api.wallet.service.v1.SetAppDownloadRewardConfigResponse\"?\x82\xd3\xe4\x93\x029:\x01*\"4/v1/backoffice/wallet/app-download-reward/config/set\x12\xd6\x01\n" +
	"\x1aGetAppDownloadRewardConfig\x12<.api.backoffice.service.v1.GetAppDownloadRewardConfigRequest\x1a9.api.wallet.service.v1.GetAppDownloadRewardConfigResponse\"?\x82\xd3\xe4\x93\x029:\x01*\"4/v1/backoffice/wallet/app-download-reward/config/get\x12\xb5\x01\n" +
	"\x12SetUserSwapEnabled\x124.api.backoffice.service.v1.SetUserSwapEnabledRequest\x1a1.api.wallet.service.v1.SetUserSwapEnabledResponse\"6\x82\xd3\xe4\x93\x020:\x01*\"+/v1/backoffice/wallet/user-swap/enabled/set\x12\xb9\x01\n" +
	"\x13SetUserSwapTemplate\x125.api.backoffice.service.v1.SetUserSwapTemplateRequest\x1a2.api.wallet.service.v1.SetUserSwapTemplateResponse\"7\x82\xd3\xe4\x93\x021:\x01*\",/v1/backoffice/wallet/user-swap/template/set\x12\xb1\x01\n" +
	"\x11GetUserSwapConfig\x123.api.backoffice.service.v1.GetUserSwapConfigRequest\x1a0.api.wallet.service.v1.GetUserSwapConfigResponse\"5\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/backoffice/wallet/user-swap/config/get\x12\xc9\x01\n" +
	...
	"\x1cUpdateOperatorCurrencyConfig\x12>.api.backoffice.service.v1.UpdateOperatorCurrencyConfigRequest\x1a;.api.wallet.service.v1.UpdateOperatorCurrencyConfigResponse\"7\x82\xd3\xe4\x93\x021:\x01*\",/v1/backoffice/wallet/currency/config/update\x12\xb1\x01\n" +
	"\x1ePushBetLimitsToBottomOperators\x12/.api.backoffice.service.v1.PushBetLimitsRequest\x1a,.api.wallet.service.v1.PushBetLimitsResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/backoffice/wallet/bet-limits/push\x12\xaa\x01\n" +
	"\x17PullBetLimitsFromSystem\x12/.api.backoffice.service.v1.PullBetLimitsRequest\x1a,.api.wallet.service.v1.PullBetLimitsResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/backoffice/wallet/bet-limits/pull\x12\xad\x01\n" +
	...
	"\x1fManualAdjustCreditTurnoverField\x12A.api.backoffice.service.v1.ManualAdjustCreditTurnoverFieldRequest\x1a>.api.wallet.service.v1.ManualAdjustCreditTurnoverFieldResponse\"5\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/backoffice/wallet/credit/manual_adjust\x12\xe9\x01\n" +
	"\x1fListOperatorWithdrawableAmounts\x12A.api.backoffice.service.v1.ListOperatorWithdrawableAmountsRequest\x1a>.api.wallet.service.v1.ListOperatorWithdrawableAmountsResponse\"C\x82\xd3\xe4\x93\x02=:\x01*\"8/v1/backoffice/wallet/operator/withdrawable-amounts/list\x12\xdf\x01\n" +
	"\x1dGetOperatorWithdrawableAmount\x12A.api.backoffice.service.v1.BOGetOperatorWithdrawableAmountRequest\x1a<.api.wallet.service.v1.GetOperatorWithdrawableAmountResponse\"=\x82\xd3\xe4\x93\x027:\x01*\"2/v1/backoffice/wallet/operator/withdrawable-amount\x12\xb8\x01\n" +
	"\x13ListUserFreeRewards\x127.api.backoffice.service.v1.BOListUserFreeRewardsRequest\x1a4.api.wallet.service.v1.ListUserFreeRewardsBOResponse\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/v1/backoffice/wallet/free-rewards/listB[\n" +
...
var file_backoffice_service_v1_backoffice_wallet_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_backoffice_service_v1_backoffice_wallet_proto_msgTypes = make([]protoimpl.MessageInfo, 89)
var file_backoffice_service_v1_backoffice_wallet_proto_goTypes = []any{
	(SubAccountTransferRequest_Direction)(0),                         // 0: api.backoffice.service.v1.SubAccountTransferRequest.Direction
	(*GetWalletsRequest)(nil),                                        // 1: api.backoffice.service.v1.GetWalletsRequest
	...
	(*ListOperatorBalancesRequest)(nil),                              // 15: api.backoffice.service.v1.ListOperatorBalancesRequest
	(*ListCompanyBalancesRequest)(nil),                               // 16: api.backoffice.service.v1.ListCompanyBalancesRequest
	...
	(*OperatorBalanceAdjustRequest)(nil),                             // 29: api.backoffice.service.v1.OperatorBalanceAdjustRequest
	(*OperatorBalanceAdjustResponse)(nil),                            // 30: api.backoffice.service.v1.OperatorBalanceAdjustResponse
	(*EnableOperatorSubAccountRequest)(nil),                          // 31: api.backoffice.service.v1.EnableOperatorSubAccountRequest
	(*EnableOperatorSubAccountResponse)(nil),                         // 32: api.backoffice.service.v1.EnableOperatorSubAccountResponse
	(*DisableOperatorSubAccountRequest)(nil),                         // 33: api.backoffice.service.v1.DisableOperatorSubAccountRequest
	(*DisableOperatorSubAccountResponse)(nil),                        // 34: api.backoffice.service.v1.DisableOperatorSubAccountResponse
	(*SubAccountTransferRequest)(nil),                                // 35: api.backoffice.service.v1.SubAccountTransferRequest
	(*SubAccountTransferResponse)(nil),                               // 36: api.backoffice.service.v1.SubAccountTransferResponse
	(*SubAccountAdjustRequest)(nil),                                  // 37: api.backoffice.service.v1.SubAccountAdjustRequest
	(*SubAccountAdjustResponse)(nil),                                 // 38: api.backoffice.service.v1.SubAccountAdjustResponse
	(*GetOperatorSubAccountRequest)(nil),                             // 39: api.backoffice.service.v1.GetOperatorSubAccountRequest
	(*ListOperatorSubAccountTransactionsRequest)(nil),                // 40: api.backoffice.service.v1.ListOperatorSubAccountTransactionsRequest
	(*ListOperatorBalanceTransactionsRequest)(nil),                   // 41: api.backoffice.service.v1.ListOperatorBalanceTransactionsRequest
	(*OperatorBalanceTransaction)(nil),                               // 42: api.backoffice.service.v1.OperatorBalanceTransaction
	(*ListOperatorBalanceTransactionsResponse)(nil),                  // 43: api.backoffice.service.v1.ListOperatorBalanceTransactionsResponse
	(*UpdateOperatorBalanceRequest)(nil),                             // 44: api.backoffice.service.v1.UpdateOperatorBalanceRequest
	(*UpdateOperatorBalanceResponse)(nil),                            // 45: api.backoffice.service.v1.UpdateOperatorBalanceResponse
	(*GetOperatorBalanceRequest)(nil),                                // 46: api.backoffice.service.v1.GetOperatorBalanceRequest
	(*SetDepositRewardSequencesRequest)(nil),                         // 47: api.backoffice.service.v1.SetDepositRewardSequencesRequest
	(*DeleteDepositRewardSequencesRequest)(nil),                      // 48: api.backoffice.service.v1.DeleteDepositRewardSequencesRequest
	(*GetDepositRewardConfigRequest)(nil),                            // 49: api.backoffice.service.v1.GetDepositRewardConfigRequest
	(*SetUserSwapEnabledRequest)(nil),                                // 50: api.backoffice.service.v1.SetUserSwapEnabledRequest
	(*SetUserSwapTemplateRequest)(nil),                               // 51: api.backoffice.service.v1.SetUserSwapTemplateRequest
	(*GetUserSwapConfigRequest)(nil),                                 // 52: api.backoffice.service.v1.GetUserSwapConfigRequest
	(*GetGamificationCurrencyConfigRequest)(nil),                     // 53: api.backoffice.service.v1.GetGamificationCurrencyConfigRequest
	(*UpdateOperatorCurrencyConfigRequest)(nil),                      // 54: api.backoffice.service.v1.UpdateOperatorCurrencyConfigRequest
	(*PushBetLimitsRequest)(nil),                                     // 55: api.backoffice.service.v1.PushBetLimitsRequest
	(*PullBetLimitsRequest)(nil),                                     // 56: api.backoffice.service.v1.PullBetLimitsRequest
	(*UpdateWalletConfigRequest)(nil),                                // 57: api.backoffice.service.v1.UpdateWalletConfigRequest
	(*DeleteWalletResponsibleGamblingConfigRequest)(nil),             // 58: api.backoffice.service.v1.DeleteWalletResponsibleGamblingConfigRequest
	(*ListWalletResponsibleGamblingConfigsRequest)(nil),              // 59: api.backoffice.service.v1.ListWalletResponsibleGamblingConfigsRequest
	(*ListCustomerRecordsRequest)(nil),                               // 60: api.backoffice.service.v1.ListCustomerRecordsRequest
	(*ExportCustomerRecordsRequest)(nil),                             // 61: api.backoffice.service.v1.ExportCustomerRecordsRequest
	(*SetFICAThresholdConfigRequest)(nil),                            // 62: api.backoffice.service.v1.SetFICAThresholdConfigRequest
	(*GetFICAThresholdConfigRequest)(nil),                            // 63: api.backoffice.service.v1.GetFICAThresholdConfigRequest
	(*ListFICAThresholdTransactionsRequest)(nil),                     // 64: api.backoffice.service.v1.ListFICAThresholdTransactionsRequest
	(*ExportFICAThresholdTransactionsRequest)(nil),                   // 65: api.backoffice.service.v1.ExportFICAThresholdTransactionsRequest
	(*ManualCreditRequest)(nil),                                      // 66: api.backoffice.service.v1.ManualCreditRequest
	(*ManualDebitRequest)(nil),                                       // 67: api.backoffice.service.v1.ManualDebitRequest
	(*ListManualJournalEntriesRequest)(nil),                          // 68: api.backoffice.service.v1.ListManualJournalEntriesRequest
	(*ExportManualJournalEntriesRequest)(nil),                        // 69: api.backoffice.service.v1.ExportManualJournalEntriesRequest
	(*CreatePromoCodeCampaignRequest)(nil),                           // 70: api.backoffice.service.v1.CreatePromoCodeCampaignRequest
	(*UpdatePromoCodeCampaignRequest)(nil),                           // 71: api.backoffice.service.v1.UpdatePromoCodeCampaignRequest
	(*UpdatePromoCodeCampaignStatusRequest)(nil),                     // 72: api.backoffice.service.v1.UpdatePromoCodeCampaignStatusRequest
	(*ListPromoCodeCampaignsRequest)(nil),                            // 73: api.backoffice.service.v1.ListPromoCodeCampaignsRequest
	(*ListPromoCodeCampaignDetailsRequest)(nil),                      // 74: api.backoffice.service.v1.ListPromoCodeCampaignDetailsRequest
	(*GenerateOneTimePromoCodesRequest)(nil),                         // 75: api.backoffice.service.v1.GenerateOneTimePromoCodesRequest
	(*GenerateUniversalPromoCodesRequest)(nil),                       // 76: api.backoffice.service.v1.GenerateUniversalPromoCodesRequest
	(*ListUniversalCodeUsagesRequest)(nil),                           // 77: api.backoffice.service.v1.ListUniversalCodeUsagesRequest
	(*ExportPromoCodesRequest)(nil),                                  // 78: api.backoffice.service.v1.ExportPromoCodesRequest
	(*ManualAdjustCreditTurnoverFieldRequest)(nil),                   // 79: api.backoffice.service.v1.ManualAdjustCreditTurnoverFieldRequest
	(*SetAppDownloadRewardConfigRequest)(nil),                        // 80: api.backoffice.service.v1.SetAppDownloadRewardConfigRequest
	(*GetAppDownloadRewardConfigRequest)(nil),                        // 81: api.backoffice.service.v1.GetAppDownloadRewardConfigRequest
	(*ListOperatorWithdrawableAmountsRequest)(nil),                   // 82: api.backoffice.service.v1.ListOperatorWithdrawableAmountsRequest
	(*BOGetOperatorWithdrawableAmountRequest)(nil),                   // 83: api.backoffice.service.v1.BOGetOperatorWithdrawableAmountRequest
	(*BOListUserFreeRewardsRequest)(nil),                             // 84: api.backoffice.service.v1.BOListUserFreeRewardsRequest
	(*GetWalletCreditsResponse_Credit)(nil),                          // 85: api.backoffice.service.v1.GetWalletCreditsResponse.Credit
	(*ListWalletBalanceTransactionsResponse_BalanceTransaction)(nil), // 86: api.backoffice.service.v1.ListWalletBalanceTransactionsResponse.BalanceTransaction
	(*GetWalletCreditTransactionsResponse_CreditTransaction)(nil),    // 87: api.backoffice.service.v1.GetWalletCreditTransactionsResponse.CreditTransaction
	nil,                                                   // 88: api.backoffice.service.v1.GetExchangeRatesResponse.ExchangeRatesEntry
	nil,                                                   // 89: api.backoffice.service.v1.GetExchangeRatesResponse.SwapFeesEntry
	...
	(*v1.RewardSequence)(nil),                             // 93: api.wallet.service.v1.RewardSequence
	(*v1.UserSwapConfig)(nil),                             // 94: api.wallet.service.v1.UserSwapConfig
	(*v1.OperatorCurrencyConfig)(nil),                     // 95: api.wallet.service.v1.OperatorCurrencyConfig
	(*v1.WalletConfig)(nil),                               // 96: api.wallet.service.v1.WalletConfig
	(*v1.FICAThresholdConfig)(nil),                        // 97: api.wallet.service.v1.FICAThresholdConfig
	(*v1.PromoCodeConditions)(nil),                        // 98: api.wallet.service.v1.PromoCodeConditions
	(*v1.PromoCodeRewardConfigs)(nil),                     // 99: api.wallet.service.v1.PromoCodeRewardConfigs
	(*v1.AppDownloadRewardConfigItem)(nil),                // 100: api.wallet.service.v1.AppDownloadRewardConfigItem
	(*v1.GetWalletsResponse)(nil),                         // 101: api.wallet.service.v1.GetWalletsResponse
	(*v1.ListCurrenciesResponse)(nil),                     // 102: api.wallet.service.v1.ListCurrenciesResponse
	(*v1.UpdateOperatorCurrencyResponse)(nil),             // 103: api.wallet.service.v1.UpdateOperatorCurrencyResponse
	(*v1.ListBottomOperatorBalancesResponse)(nil),         // 104: api.wallet.service.v1.ListBottomOperatorBalancesResponse
	(*v1.ListCompanyOperatorBalancesResponse)(nil),        // 105: api.wallet.service.v1.ListCompanyOperatorBalancesResponse
	(*v1.GetOperatorSubAccountResponse)(nil),              // 106: api.wallet.service.v1.GetOperatorSubAccountResponse
	(*v1.ListOperatorSubAccountTransactionsResponse)(nil), // 107: api.wallet.service.v1.ListOperatorSubAccountTransactionsResponse
	...
	(*v1.GetDepositRewardConfigResponse)(nil),             // 111: api.wallet.service.v1.GetDepositRewardConfigResponse
	(*v1.SetAppDownloadRewardConfigResponse)(nil),         // 112: api.wallet.service.v1.SetAppDownloadRewardConfigResponse
	(*v1.GetAppDownloadRewardConfigResponse)(nil),         // 113: api.wallet.service.v1.GetAppDownloadRewardConfigResponse
	(*v1.SetUserSwapEnabledResponse)(nil),                 // 114: api.wallet.service.v1.SetUserSwapEnabledResponse
	(*v1.SetUserSwapTemplateResponse)(nil),                // 115: api.wallet.service.v1.SetUserSwapTemplateResponse
	(*v1.GetUserSwapConfigResponse)(nil),                  // 116: api.wallet.service.v1.GetUserSwapConfigResponse
	(*v1.CreatePromoCodeCampaignResponse)(nil),            // 117: api.wallet.service.v1.CreatePromoCodeCampaignResponse
	(*v1.UpdatePromoCodeCampaignResponse)(nil),            // 118: api.wallet.service.v1.UpdatePromoCodeCampaignResponse
	(*v1.UpdatePromoCodeCampaignStatusResponse)(nil),      // 119: api.wallet.service.v1.UpdatePromoCodeCampaignStatusResponse
	(*v1.ListPromoCodeCampaignsResponse)(nil),             // 120: api.wallet.service.v1.ListPromoCodeCampaignsResponse
	(*v1.ListPromoCodeCampaignDetailsResponse)(nil),       // 121: api.wallet.service.v1.ListPromoCodeCampaignDetailsResponse
	(*v1.GenerateOneTimePromoCodesResponse)(nil),          // 122: api.wallet.service.v1.GenerateOneTimePromoCodesResponse
	(*v1.GenerateUniversalPromoCodesResponse)(nil),        // 123: api.wallet.service.v1.GenerateUniversalPromoCodesResponse
	(*v1.ListUniversalCodeUsagesResponse)(nil),            // 124: api.wallet.service.v1.ListUniversalCodeUsagesResponse
	(*v1.ExportPromoCodesResponse)(nil),                   // 125: api.wallet.service.v1.ExportPromoCodesResponse
	(*v1.GetGamificationCurrencyConfigResponse)(nil),      // 126: api.wallet.service.v1.GetGamificationCurrencyConfigResponse
	(*v1.UpdateOperatorCurrencyConfigResponse)(nil),       // 127: api.wallet.service.v1.UpdateOperatorCurrencyConfigResponse
	(*v1.PushBetLimitsResponse)(nil),                      // 128: api.wallet.service.v1.PushBetLimitsResponse
	(*v1.PullBetLimitsResponse)(nil),                      // 129: api.wallet.service.v1.PullBetLimitsResponse
	(*v1.UpdateWalletConfigResponse)(nil),                 // 130: api.wallet.service.v1.UpdateWalletConfigResponse
	(*v1.DeleteResponsibleGamblingConfigResponse)(nil),    // 131: api.wallet.service.v1.DeleteResponsibleGamblingConfigResponse
	(*v1.ListResponsibleGamblingConfigsResponse)(nil),     // 132: api.wallet.service.v1.ListResponsibleGamblingConfigsResponse
	(*v1.ListCustomerRecordsResponse)(nil),                // 133: api.wallet.service.v1.ListCustomerRecordsResponse
	(*v1.ExportCustomerRecordsResponse)(nil),              // 134: api.wallet.service.v1.ExportCustomerRecordsResponse
	(*v1.SetFICAThresholdConfigResponse)(nil),             // 135: api.wallet.service.v1.SetFICAThresholdConfigResponse
	(*v1.GetFICAThresholdConfigResponse)(nil),             // 136: api.wallet.service.v1.GetFICAThresholdConfigResponse
	(*v1.ListFICAThresholdTransactionsResponse)(nil),      // 137: api.wallet.service.v1.ListFICAThresholdTransactionsResponse
	(*v1.ExportFICAThresholdTransactionsResponse)(nil),    // 138: api.wallet.service.v1.ExportFICAThresholdTransactionsResponse
	(*v1.CreditResponse)(nil),                             // 139: api.wallet.service.v1.CreditResponse
	(*v1.DebitResponse)(nil),                              // 140: api.wallet.service.v1.DebitResponse
	(*v1.ListManualJournalEntriesResponse)(nil),           // 141: api.wallet.service.v1.ListManualJournalEntriesResponse
	(*v1.ExportManualJournalEntriesResponse)(nil),         // 142: api.wallet.service.v1.ExportManualJournalEntriesResponse
	(*v1.ManualAdjustCreditTurnoverFieldResponse)(nil),    // 143: api.wallet.service.v1.ManualAdjustCreditTurnoverFieldResponse
	(*v1.ListOperatorWithdrawableAmountsResponse)(nil),    // 144: api.wallet.service.v1.ListOperatorWithdrawableAmountsResponse
	(*v1.GetOperatorWithdrawableAmountResponse)(nil),      // 145: api.wallet.service.v1.GetOperatorWithdrawableAmountResponse
	(*v1.ListUserFreeRewardsBOResponse)(nil),              // 146: api.wallet.service.v1.ListUserFreeRewardsBOResponse
}
var file_backoffice_service_v1_backoffice_wallet_proto_depIdxs = []int32{
	90,  // 0: api.backoffice.service.v1.GetWalletCreditsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 1: api.backoffice.service.v1.GetWalletCreditsRequest.end_time:type_name -> google.protobuf.Timestamp
	85,  // 2: api.backoffice.service.v1.GetWalletCreditsResponse.credits:type_name -> api.backoffice.service.v1.GetWalletCreditsResponse.Credit
	90,  // 3: api.backoffice.service.v1.ListWalletBalanceTransactionsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 4: api.backoffice.service.v1.ListWalletBalanceTransactionsRequest.end_time:type_name -> google.protobuf.Timestamp
	86,  // 5: api.backoffice.service.v1.ListWalletBalanceTransactionsResponse.balance_transactions:type_name -> api.backoffice.service.v1.ListWalletBalanceTransactionsResponse.BalanceTransaction
	87,  // 6: api.backoffice.service.v1.GetWalletCreditTransactionsResponse.credit_transactions:type_name -> api.backoffice.service.v1.GetWalletCreditTransactionsResponse.CreditTransaction
	91,  // 7: api.backoffice.service.v1.ListWalletCurrenciesRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 8: api.backoffice.service.v1.UpdateWalletCurrencyRequest.target_operator_context:type_name -> api.common.OperatorContext
	92,  // 9: api.backoffice.service.v1.ListOperatorBalancesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	92,  // 10: api.backoffice.service.v1.ListCompanyBalancesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	88,  // 11: api.backoffice.service.v1.GetExchangeRatesResponse.exchange_rates:type_name -> api.backoffice.service.v1.GetExchangeRatesResponse.ExchangeRatesEntry
	89,  // 12: api.backoffice.service.v1.GetExchangeRatesResponse.swap_fees:type_name -> api.backoffice.service.v1.GetExchangeRatesResponse.SwapFeesEntry
	91,  // 13: api.backoffice.service.v1.OperatorTransferRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 14: api.backoffice.service.v1.OperatorSwapRequest.source_operator_context:type_name -> api.common.OperatorContext
	91,  // 15: api.backoffice.service.v1.OperatorSwapRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 16: api.backoffice.service.v1.OperatorBalanceFreezeRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 17: api.backoffice.service.v1.OperatorBalanceRollbackRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 18: api.backoffice.service.v1.OperatorBalanceSettleRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 19: api.backoffice.service.v1.OperatorBalanceAdjustRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 20: api.backoffice.service.v1.EnableOperatorSubAccountRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 21: api.backoffice.service.v1.DisableOperatorSubAccountRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 22: api.backoffice.service.v1.SubAccountTransferRequest.operator_context:type_name -> api.common.OperatorContext
	0,   // 23: api.backoffice.service.v1.SubAccountTransferRequest.direction:type_name -> api.backoffice.service.v1.SubAccountTransferRequest.Direction
	91,  // 24: api.backoffice.service.v1.SubAccountAdjustRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 25: api.backoffice.service.v1.GetOperatorSubAccountRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 26: api.backoffice.service.v1.ListOperatorSubAccountTransactionsRequest.operator_context:type_name -> api.common.OperatorContext
	90,  // 27: api.backoffice.service.v1.ListOperatorSubAccountTransactionsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 28: api.backoffice.service.v1.ListOperatorSubAccountTransactionsRequest.end_time:type_name -> google.protobuf.Timestamp
	92,  // 29: api.backoffice.service.v1.ListOperatorBalanceTransactionsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	90,  // 30: api.backoffice.service.v1.ListOperatorBalanceTransactionsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 31: api.backoffice.service.v1.ListOperatorBalanceTransactionsRequest.end_time:type_name -> google.protobuf.Timestamp
	91,  // 32: api.backoffice.service.v1.OperatorBalanceTransaction.operator_context:type_name -> api.common.OperatorContext
	90,  // 33: api.backoffice.service.v1.OperatorBalanceTransaction.created_at:type_name -> google.protobuf.Timestamp
	90,  // 34: api.backoffice.service.v1.OperatorBalanceTransaction.updated_at:type_name -> google.protobuf.Timestamp
	42,  // 35: api.backoffice.service.v1.ListOperatorBalanceTransactionsResponse.transactions:type_name -> api.backoffice.service.v1.OperatorBalanceTransaction
	91,  // 36: api.backoffice.service.v1.UpdateOperatorBalanceRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 37: api.backoffice.service.v1.GetOperatorBalanceRequest.operator_context:type_name -> api.common.OperatorContext
	91,  // 38: api.backoffice.service.v1.SetDepositRewardSequencesRequest.target_operator_context:type_name -> api.common.OperatorContext
	93,  // 39: api.backoffice.service.v1.SetDepositRewardSequencesRequest.welcome_reward_sequences:type_name -> api.wallet.service.v1.RewardSequence
	93,  // 40: api.backoffice.service.v1.SetDepositRewardSequencesRequest.daily_reward_sequences:type_name -> api.wallet.service.v1.RewardSequence
	91,  // 41: api.backoffice.service.v1.DeleteDepositRewardSequencesRequest.target_operator_context:type_name -> api.common.OperatorContext
	93,  // 42: api.backoffice.service.v1.DeleteDepositRewardSequencesRequest.welcome_reward_sequences:type_name -> api.wallet.service.v1.RewardSequence
	93,  // 43: api.backoffice.service.v1.DeleteDepositRewardSequencesRequest.daily_reward_sequences:type_name -> api.wallet.service.v1.RewardSequence
	91,  // 44: api.backoffice.service.v1.GetDepositRewardConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 45: api.backoffice.service.v1.SetUserSwapEnabledRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 46: api.backoffice.service.v1.SetUserSwapTemplateRequest.target_operator_context:type_name -> api.common.OperatorContext
	94,  // 47: api.backoffice.service.v1.SetUserSwapTemplateRequest.config:type_name -> api.wallet.service.v1.UserSwapConfig
	91,  // 48: api.backoffice.service.v1.GetUserSwapConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 49: api.backoffice.service.v1.GetGamificationCurrencyConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 50: api.backoffice.service.v1.UpdateOperatorCurrencyConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	95,  // 51: api.backoffice.service.v1.UpdateOperatorCurrencyConfigRequest.operator_currency_config:type_name -> api.wallet.service.v1.OperatorCurrencyConfig
	91,  // 52: api.backoffice.service.v1.PullBetLimitsRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 53: api.backoffice.service.v1.UpdateWalletConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	96,  // 54: api.backoffice.service.v1.UpdateWalletConfigRequest.wallet_config:type_name -> api.wallet.service.v1.WalletConfig
	90,  // 55: api.backoffice.service.v1.ListCustomerRecordsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 56: api.backoffice.service.v1.ListCustomerRecordsRequest.end_time:type_name -> google.protobuf.Timestamp
	92,  // 57: api.backoffice.service.v1.ListCustomerRecordsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	90,  // 58: api.backoffice.service.v1.ExportCustomerRecordsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 59: api.backoffice.service.v1.ExportCustomerRecordsRequest.end_time:type_name -> google.protobuf.Timestamp
	92,  // 60: api.backoffice.service.v1.ExportCustomerRecordsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	97,  // 61: api.backoffice.service.v1.SetFICAThresholdConfigRequest.fica_threshold_config:type_name -> api.wallet.service.v1.FICAThresholdConfig
	91,  // 62: api.backoffice.service.v1.SetFICAThresholdConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 63: api.backoffice.service.v1.GetFICAThresholdConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 64: api.backoffice.service.v1.ListFICAThresholdTransactionsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 65: api.backoffice.service.v1.ListFICAThresholdTransactionsRequest.end_time:type_name -> google.protobuf.Timestamp
	91,  // 66: api.backoffice.service.v1.ListFICAThresholdTransactionsRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 67: api.backoffice.service.v1.ExportFICAThresholdTransactionsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 68: api.backoffice.service.v1.ExportFICAThresholdTransactionsRequest.end_time:type_name -> google.protobuf.Timestamp
	91,  // 69: api.backoffice.service.v1.ExportFICAThresholdTransactionsRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 70: api.backoffice.service.v1.ListManualJournalEntriesRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 71: api.backoffice.service.v1.ListManualJournalEntriesRequest.end_time:type_name -> google.protobuf.Timestamp
	92,  // 72: api.backoffice.service.v1.ListManualJournalEntriesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	90,  // 73: api.backoffice.service.v1.ExportManualJournalEntriesRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 74: api.backoffice.service.v1.ExportManualJournalEntriesRequest.end_time:type_name -> google.protobuf.Timestamp
	92,  // 75: api.backoffice.service.v1.ExportManualJournalEntriesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	91,  // 76: api.backoffice.service.v1.CreatePromoCodeCampaignRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 77: api.backoffice.service.v1.CreatePromoCodeCampaignRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 78: api.backoffice.service.v1.CreatePromoCodeCampaignRequest.end_time:type_name -> google.protobuf.Timestamp
	98,  // 79: api.backoffice.service.v1.CreatePromoCodeCampaignRequest.reward_conditions:type_name -> api.wallet.service.v1.PromoCodeConditions
	99,  // 80: api.backoffice.service.v1.CreatePromoCodeCampaignRequest.reward_configs:type_name -> api.wallet.service.v1.PromoCodeRewardConfigs
	91,  // 81: api.backoffice.service.v1.UpdatePromoCodeCampaignRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 82: api.backoffice.service.v1.UpdatePromoCodeCampaignRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 83: api.backoffice.service.v1.UpdatePromoCodeCampaignRequest.end_time:type_name -> google.protobuf.Timestamp
	98,  // 84: api.backoffice.service.v1.UpdatePromoCodeCampaignRequest.reward_conditions:type_name -> api.wallet.service.v1.PromoCodeConditions
	99,  // 85: api.backoffice.service.v1.UpdatePromoCodeCampaignRequest.reward_configs:type_name -> api.wallet.service.v1.PromoCodeRewardConfigs
	91,  // 86: api.backoffice.service.v1.UpdatePromoCodeCampaignStatusRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 87: api.backoffice.service.v1.ListPromoCodeCampaignsRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 88: api.backoffice.service.v1.ListPromoCodeCampaignsRequest.start_time:type_name -> google.protobuf.Timestamp
	90,  // 89: api.backoffice.service.v1.ListPromoCodeCampaignsRequest.end_time:type_name -> google.protobuf.Timestamp
	91,  // 90: api.backoffice.service.v1.SetAppDownloadRewardConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	100, // 91: api.backoffice.service.v1.SetAppDownloadRewardConfigRequest.configs:type_name -> api.wallet.service.v1.AppDownloadRewardConfigItem
	91,  // 92: api.backoffice.service.v1.GetAppDownloadRewardConfigRequest.target_operator_context:type_name -> api.common.OperatorContext
	92,  // 93: api.backoffice.service.v1.ListOperatorWithdrawableAmountsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	91,  // 94: api.backoffice.service.v1.ListOperatorWithdrawableAmountsRequest.target_operator_context:type_name -> api.common.OperatorContext
	91,  // 95: api.backoffice.service.v1.BOGetOperatorWithdrawableAmountRequest.target_operator_context:type_name -> api.common.OperatorContext
	90,  // 96: api.backoffice.service.v1.GetWalletCreditsResponse.Credit.created_at:type_name -> google.protobuf.Timestamp
	90,  // 97: api.backoffice.service.v1.ListWalletBalanceTransactionsResponse.BalanceTransaction.created_at:type_name -> google.protobuf.Timestamp
	90,  // 98: api.backoffice.service.v1.GetWalletCreditTransactionsResponse.CreditTransaction.created_at:type_name -> google.protobuf.Timestamp
	1,   // 99: api.backoffice.service.v1.BackofficeWallet.GetWallets:input_type -> api.backoffice.service.v1.GetWalletsRequest
	2,   // 100: api.backoffice.service.v1.BackofficeWallet.GetWalletCredits:input_type -> api.backoffice.service.v1.GetWalletCreditsRequest
	4,   // 101: api.backoffice.service.v1.BackofficeWallet.ListWalletBalanceTransactions:input_type -> api.backoffice.service.v1.ListWalletBalanceTransactionsRequest
	6,   // 102: api.backoffice.service.v1.BackofficeWallet.GetWalletCreditTransactions:input_type -> api.backoffice.service.v1.GetWalletCreditTransactionsRequest
	8,   // 103: api.backoffice.service.v1.BackofficeWallet.UpdateWallet:input_type -> api.backoffice.service.v1.UpdateWalletRequest
	11,  // 104: api.backoffice.service.v1.BackofficeWallet.AddWalletCurrency:input_type -> api.backoffice.service.v1.AddWalletCurrencyRequest
	13,  // 105: api.backoffice.service.v1.BackofficeWallet.ListWalletCurrencies:input_type -> api.backoffice.service.v1.ListWalletCurrenciesRequest
	14,  // 106: api.backoffice.service.v1.BackofficeWallet.UpdateWalletCurrency:input_type -> api.backoffice.service.v1.UpdateWalletCurrencyRequest
	15,  // 107: api.backoffice.service.v1.BackofficeWallet.ListOperatorBalances:input_type -> api.backoffice.service.v1.ListOperatorBalancesRequest
	16,  // 108: api.backoffice.service.v1.BackofficeWallet.ListCompanyBalances:input_type -> api.backoffice.service.v1.ListCompanyBalancesRequest
	17,  // 109: api.backoffice.service.v1.BackofficeWallet.GetExchangeRates:input_type -> api.backoffice.service.v1.GetExchangeRatesRequest
	19,  // 110: api.backoffice.service.v1.BackofficeWallet.OperatorTransfer:input_type -> api.backoffice.service.v1.OperatorTransferRequest
	21,  // 111: api.backoffice.service.v1.BackofficeWallet.OperatorSwap:input_type -> api.backoffice.service.v1.OperatorSwapRequest
	23,  // 112: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceFreeze:input_type -> api.backoffice.service.v1.OperatorBalanceFreezeRequest
	25,  // 113: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceRollback:input_type -> api.backoffice.service.v1.OperatorBalanceRollbackRequest
	27,  // 114: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceSettle:input_type -> api.backoffice.service.v1.OperatorBalanceSettleRequest
	29,  // 115: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceAdjust:input_type -> api.backoffice.service.v1.OperatorBalanceAdjustRequest
	31,  // 116: api.backoffice.service.v1.BackofficeWallet.EnableOperatorSubAccount:input_type -> api.backoffice.service.v1.EnableOperatorSubAccountRequest
	33,  // 117: api.backoffice.service.v1.BackofficeWallet.DisableOperatorSubAccount:input_type -> api.backoffice.service.v1.DisableOperatorSubAccountRequest
	35,  // 118: api.backoffice.service.v1.BackofficeWallet.SubAccountTransfer:input_type -> api.backoffice.service.v1.SubAccountTransferRequest
	37,  // 119: api.backoffice.service.v1.BackofficeWallet.SubAccountAdjust:input_type -> api.backoffice.service.v1.SubAccountAdjustRequest
	39,  // 120: api.backoffice.service.v1.BackofficeWallet.GetOperatorSubAccount:input_type -> api.backoffice.service.v1.GetOperatorSubAccountRequest
	40,  // 121: api.backoffice.service.v1.BackofficeWallet.ListOperatorSubAccountTransactions:input_type -> api.backoffice.service.v1.ListOperatorSubAccountTransactionsRequest
	41,  // 122: api.backoffice.service.v1.BackofficeWallet.ListOperatorBalanceTransactions:input_type -> api.backoffice.service.v1.ListOperatorBalanceTransactionsRequest
	44,  // 123: api.backoffice.service.v1.BackofficeWallet.UpdateOperatorBalance:input_type -> api.backoffice.service.v1.UpdateOperatorBalanceRequest
	46,  // 124: api.backoffice.service.v1.BackofficeWallet.GetOperatorBalance:input_type -> api.backoffice.service.v1.GetOperatorBalanceRequest
	47,  // 125: api.backoffice.service.v1.BackofficeWallet.SetDepositRewardSequences:input_type -> api.backoffice.service.v1.SetDepositRewardSequencesRequest
	48,  // 126: api.backoffice.service.v1.BackofficeWallet.DeleteDepositRewardSequences:input_type -> api.backoffice.service.v1.DeleteDepositRewardSequencesRequest
	49,  // 127: api.backoffice.service.v1.BackofficeWallet.GetDepositRewardConfig:input_type -> api.backoffice.service.v1.GetDepositRewardConfigRequest
	80,  // 128: api.backoffice.service.v1.BackofficeWallet.SetAppDownloadRewardConfig:input_type -> api.backoffice.service.v1.SetAppDownloadRewardConfigRequest
	81,  // 129: api.backoffice.service.v1.BackofficeWallet.GetAppDownloadRewardConfig:input_type -> api.backoffice.service.v1.GetAppDownloadRewardConfigRequest
	50,  // 130: api.backoffice.service.v1.BackofficeWallet.SetUserSwapEnabled:input_type -> api.backoffice.service.v1.SetUserSwapEnabledRequest
	51,  // 131: api.backoffice.service.v1.BackofficeWallet.SetUserSwapTemplate:input_type -> api.backoffice.service.v1.SetUserSwapTemplateRequest
	52,  // 132: api.backoffice.service.v1.BackofficeWallet.GetUserSwapConfig:input_type -> api.backoffice.service.v1.GetUserSwapConfigRequest
	70,  // 133: api.backoffice.service.v1.BackofficeWallet.CreatePromoCodeCampaign:input_type -> api.backoffice.service.v1.CreatePromoCodeCampaignRequest
	71,  // 134: api.backoffice.service.v1.BackofficeWallet.UpdatePromoCodeCampaign:input_type -> api.backoffice.service.v1.UpdatePromoCodeCampaignRequest
	72,  // 135: api.backoffice.service.v1.BackofficeWallet.UpdatePromoCodeCampaignStatus:input_type -> api.backoffice.service.v1.UpdatePromoCodeCampaignStatusRequest
	73,  // 136: api.backoffice.service.v1.BackofficeWallet.ListPromoCodeCampaigns:input_type -> api.backoffice.service.v1.ListPromoCodeCampaignsRequest
	74,  // 137: api.backoffice.service.v1.BackofficeWallet.ListPromoCodeCampaignDetails:input_type -> api.backoffice.service.v1.ListPromoCodeCampaignDetailsRequest
	75,  // 138: api.backoffice.service.v1.BackofficeWallet.GenerateOneTimePromoCodes:input_type -> api.backoffice.service.v1.GenerateOneTimePromoCodesRequest
	76,  // 139: api.backoffice.service.v1.BackofficeWallet.GenerateUniversalPromoCodes:input_type -> api.backoffice.service.v1.GenerateUniversalPromoCodesRequest
	77,  // 140: api.backoffice.service.v1.BackofficeWallet.ListUniversalCodeUsages:input_type -> api.backoffice.service.v1.ListUniversalCodeUsagesRequest
	78,  // 141: api.backoffice.service.v1.BackofficeWallet.ExportPromoCodes:input_type -> api.backoffice.service.v1.ExportPromoCodesRequest
	53,  // 142: api.backoffice.service.v1.BackofficeWallet.GetGamificationCurrencyConfig:input_type -> api.backoffice.service.v1.GetGamificationCurrencyConfigRequest
	54,  // 143: api.backoffice.service.v1.BackofficeWallet.UpdateOperatorCurrencyConfig:input_type -> api.backoffice.service.v1.UpdateOperatorCurrencyConfigRequest
	55,  // 144: api.backoffice.service.v1.BackofficeWallet.PushBetLimitsToBottomOperators:input_type -> api.backoffice.service.v1.PushBetLimitsRequest
	56,  // 145: api.backoffice.service.v1.BackofficeWallet.PullBetLimitsFromSystem:input_type -> api.backoffice.service.v1.PullBetLimitsRequest
	57,  // 146: api.backoffice.service.v1.BackofficeWallet.UpdateWalletConfig:input_type -> api.backoffice.service.v1.UpdateWalletConfigRequest
	58,  // 147: api.backoffice.service.v1.BackofficeWallet.DeleteWalletResponsibleGamblingConfig:input_type -> api.backoffice.service.v1.DeleteWalletResponsibleGamblingConfigRequest
	59,  // 148: api.backoffice.service.v1.BackofficeWallet.ListWalletResponsibleGamblingConfigs:input_type -> api.backoffice.service.v1.ListWalletResponsibleGamblingConfigsRequest
	60,  // 149: api.backoffice.service.v1.BackofficeWallet.ListCustomerRecords:input_type -> api.backoffice.service.v1.ListCustomerRecordsRequest
	61,  // 150: api.backoffice.service.v1.BackofficeWallet.ExportCustomerRecords:input_type -> api.backoffice.service.v1.ExportCustomerRecordsRequest
	62,  // 151: api.backoffice.service.v1.BackofficeWallet.SetFICAThresholdConfig:input_type -> api.backoffice.service.v1.SetFICAThresholdConfigRequest
	63,  // 152: api.backoffice.service.v1.BackofficeWallet.GetFICAThresholdConfig:input_type -> api.backoffice.service.v1.GetFICAThresholdConfigRequest
	64,  // 153: api.backoffice.service.v1.BackofficeWallet.ListFICAThresholdTransactions:input_type -> api.backoffice.service.v1.ListFICAThresholdTransactionsRequest
	65,  // 154: api.backoffice.service.v1.BackofficeWallet.ExportFICAThresholdTransactions:input_type -> api.backoffice.service.v1.ExportFICAThresholdTransactionsRequest
	66,  // 155: api.backoffice.service.v1.BackofficeWallet.ManualCredit:input_type -> api.backoffice.service.v1.ManualCreditRequest
	67,  // 156: api.backoffice.service.v1.BackofficeWallet.ManualDebit:input_type -> api.backoffice.service.v1.ManualDebitRequest
	68,  // 157: api.backoffice.service.v1.BackofficeWallet.ListManualJournalEntries:input_type -> api.backoffice.service.v1.ListManualJournalEntriesRequest
	69,  // 158: api.backoffice.service.v1.BackofficeWallet.ExportManualJournalEntries:input_type -> api.backoffice.service.v1.ExportManualJournalEntriesRequest
	79,  // 159: api.backoffice.service.v1.BackofficeWallet.ManualAdjustCreditTurnoverField:input_type -> api.backoffice.service.v1.ManualAdjustCreditTurnoverFieldRequest
	82,  // 160: api.backoffice.service.v1.BackofficeWallet.ListOperatorWithdrawableAmounts:input_type -> api.backoffice.service.v1.ListOperatorWithdrawableAmountsRequest
	83,  // 161: api.backoffice.service.v1.BackofficeWallet.GetOperatorWithdrawableAmount:input_type -> api.backoffice.service.v1.BOGetOperatorWithdrawableAmountRequest
	84,  // 162: api.backoffice.service.v1.BackofficeWallet.ListUserFreeRewards:input_type -> api.backoffice.service.v1.BOListUserFreeRewardsRequest
	101, // 163: api.backoffice.service.v1.BackofficeWallet.GetWallets:output_type -> api.wallet.service.v1.GetWalletsResponse
	3,   // 164: api.backoffice.service.v1.BackofficeWallet.GetWalletCredits:output_type -> api.backoffice.service.v1.GetWalletCreditsResponse
	5,   // 165: api.backoffice.service.v1.BackofficeWallet.ListWalletBalanceTransactions:output_type -> api.backoffice.service.v1.ListWalletBalanceTransactionsResponse
	7,   // 166: api.backoffice.service.v1.BackofficeWallet.GetWalletCreditTransactions:output_type -> api.backoffice.service.v1.GetWalletCreditTransactionsResponse
	9,   // 167: api.backoffice.service.v1.BackofficeWallet.UpdateWallet:output_type -> api.backoffice.service.v1.UpdateWalletResponse
	12,  // 168: api.backoffice.service.v1.BackofficeWallet.AddWalletCurrency:output_type -> api.backoffice.service.v1.AddWalletCurrencyResponse
	102, // 169: api.backoffice.service.v1.BackofficeWallet.ListWalletCurrencies:output_type -> api.wallet.service.v1.ListCurrenciesResponse
	103, // 170: api.backoffice.service.v1.BackofficeWallet.UpdateWalletCurrency:output_type -> api.wallet.service.v1.UpdateOperatorCurrencyResponse
	104, // 171: api.backoffice.service.v1.BackofficeWallet.ListOperatorBalances:output_type -> api.wallet.service.v1.ListBottomOperatorBalancesResponse
	105, // 172: api.backoffice.service.v1.BackofficeWallet.ListCompanyBalances:output_type -> api.wallet.service.v1.ListCompanyOperatorBalancesResponse
	18,  // 173: api.backoffice.service.v1.BackofficeWallet.GetExchangeRates:output_type -> api.backoffice.service.v1.GetExchangeRatesResponse
	20,  // 174: api.backoffice.service.v1.BackofficeWallet.OperatorTransfer:output_type -> api.backoffice.service.v1.OperatorTransferResponse
	22,  // 175: api.backoffice.service.v1.BackofficeWallet.OperatorSwap:output_type -> api.backoffice.service.v1.OperatorSwapResponse
	24,  // 176: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceFreeze:output_type -> api.backoffice.service.v1.OperatorBalanceFreezeResponse
	26,  // 177: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceRollback:output_type -> api.backoffice.service.v1.OperatorBalanceRollbackResponse
	28,  // 178: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceSettle:output_type -> api.backoffice.service.v1.OperatorBalanceSettleResponse
	30,  // 179: api.backoffice.service.v1.BackofficeWallet.OperatorBalanceAdjust:output_type -> api.backoffice.service.v1.OperatorBalanceAdjustResponse
	32,  // 180: api.backoffice.service.v1.BackofficeWallet.EnableOperatorSubAccount:output_type -> api.backoffice.service.v1.EnableOperatorSubAccountResponse
	34,  // 181: api.backoffice.service.v1.BackofficeWallet.DisableOperatorSubAccount:output_type -> api.backoffice.service.v1.DisableOperatorSubAccountResponse
	36,  // 182: api.backoffice.service.v1.BackofficeWallet.SubAccountTransfer:output_type -> api.backoffice.service.v1.SubAccountTransferResponse
	38,  // 183: api.backoffice.service.v1.BackofficeWallet.SubAccountAdjust:output_type -> api.backoffice.service.v1.SubAccountAdjustResponse
	106, // 184: api.backoffice.service.v1.BackofficeWallet.GetOperatorSubAccount:output_type -> api.wallet.service.v1.GetOperatorSubAccountResponse
	107, // 185: api.backoffice.service.v1.BackofficeWallet.ListOperatorSubAccountTransactions:output_type -> api.wallet.service.v1.ListOperatorSubAccountTransactionsResponse
	43,  // 186: api.backoffice.service.v1.BackofficeWallet.ListOperatorBalanceTransactions:output_type -> api.backoffice.service.v1.ListOperatorBalanceTransactionsResponse
	45,  // 187: api.backoffice.service.v1.BackofficeWallet.UpdateOperatorBalance:output_type -> api.backoffice.service.v1.UpdateOperatorBalanceResponse
	108, // 188: api.backoffice.service.v1.BackofficeWallet.GetOperatorBalance:output_type -> api.wallet.service.v1.GetOperatorBalanceResponse
	109, // 189: api.backoffice.service.v1.BackofficeWallet.SetDepositRewardSequences:output_type -> api.wallet.service.v1.SetDepositRewardSequencesResponse
	110, // 190: api.backoffice.service.v1.BackofficeWallet.DeleteDepositRewardSequences:output_type -> api.wallet.service.v1.DeleteDepositRewardSequencesResponse
	111, // 191: api.backoffice.service.v1.BackofficeWallet.GetDepositRewardConfig:output_type -> api.wallet.service.v1.GetDepositRewardConfigResponse
	112, // 192: api.backoffice.service.v1.BackofficeWallet.SetAppDownloadRewardConfig:output_type -> api.wallet.service.v1.SetAppDownloadRewardConfigResponse
	113, // 193: api.backoffice.service.v1.BackofficeWallet.GetAppDownloadRewardConfig:output_type -> api.wallet.service.v1.GetAppDownloadRewardConfigResponse
	114, // 194: api.backoffice.service.v1.BackofficeWallet.SetUserSwapEnabled:output_type -> api.wallet.service.v1.SetUserSwapEnabledResponse
	115, // 195: api.backoffice.service.v1.BackofficeWallet.SetUserSwapTemplate:output_type -> api.wallet.service.v1.SetUserSwapTemplateResponse
	116, // 196: api.backoffice.service.v1.BackofficeWallet.GetUserSwapConfig:output_type -> api.wallet.service.v1.GetUserSwapConfigResponse
	117, // 197: api.backoffice.service.v1.BackofficeWallet.CreatePromoCodeCampaign:output_type -> api.wallet.service.v1.CreatePromoCodeCampaignResponse
	118, // 198: api.backoffice.service.v1.BackofficeWallet.UpdatePromoCodeCampaign:output_type -> api.wallet.service.v1.UpdatePromoCodeCampaignResponse
	119, // 199: api.backoffice.service.v1.BackofficeWallet.UpdatePromoCodeCampaignStatus:output_type -> api.wallet.service.v1.UpdatePromoCodeCampaignStatusResponse
	120, // 200: api.backoffice.service.v1.BackofficeWallet.ListPromoCodeCampaigns:output_type -> api.wallet.service.v1.ListPromoCodeCampaignsResponse
	121, // 201: api.backoffice.service.v1.BackofficeWallet.ListPromoCodeCampaignDetails:output_type -> api.wallet.service.v1.ListPromoCodeCampaignDetailsResponse
	122, // 202: api.backoffice.service.v1.BackofficeWallet.GenerateOneTimePromoCodes:output_type -> api.wallet.service.v1.GenerateOneTimePromoCodesResponse
	123, // 203: api.backoffice.service.v1.BackofficeWallet.GenerateUniversalPromoCodes:output_type -> api.wallet.service.v1.GenerateUniversalPromoCodesResponse
	124, // 204: api.backoffice.service.v1.BackofficeWallet.ListUniversalCodeUsages:output_type -> api.wallet.service.v1.ListUniversalCodeUsagesResponse
	125, // 205: api.backoffice.service.v1.BackofficeWallet.ExportPromoCodes:output_type -> api.wallet.service.v1.ExportPromoCodesResponse
	126, // 206: api.backoffice.service.v1.BackofficeWallet.GetGamificationCurrencyConfig:output_type -> api.wallet.service.v1.GetGamificationCurrencyConfigResponse
	127, // 207: api.backoffice.service.v1.BackofficeWallet.UpdateOperatorCurrencyConfig:output_type -> api.wallet.service.v1.UpdateOperatorCurrencyConfigResponse
	128, // 208: api.backoffice.service.v1.BackofficeWallet.PushBetLimitsToBottomOperators:output_type -> api.wallet.service.v1.PushBetLimitsResponse
	129, // 209: api.backoffice.service.v1.BackofficeWallet.PullBetLimitsFromSystem:output_type -> api.wallet.service.v1.PullBetLimitsResponse
	130, // 210: api.backoffice.service.v1.BackofficeWallet.UpdateWalletConfig:output_type -> api.wallet.service.v1.UpdateWalletConfigResponse
	131, // 211: api.backoffice.service.v1.BackofficeWallet.DeleteWalletResponsibleGamblingConfig:output_type -> api.wallet.service.v1.DeleteResponsibleGamblingConfigResponse
	132, // 212: api.backoffice.service.v1.BackofficeWallet.ListWalletResponsibleGamblingConfigs:output_type -> api.wallet.service.v1.ListResponsibleGamblingConfigsResponse
	133, // 213: api.backoffice.service.v1.BackofficeWallet.ListCustomerRecords:output_type -> api.wallet.service.v1.ListCustomerRecordsResponse
	134, // 214: api.backoffice.service.v1.BackofficeWallet.ExportCustomerRecords:output_type -> api.wallet.service.v1.ExportCustomerRecordsResponse
	135, // 215: api.backoffice.service.v1.BackofficeWallet.SetFICAThresholdConfig:output_type -> api.wallet.service.v1.SetFICAThresholdConfigResponse
	136, // 216: api.backoffice.service.v1.BackofficeWallet.GetFICAThresholdConfig:output_type -> api.wallet.service.v1.GetFICAThresholdConfigResponse
	137, // 217: api.backoffice.service.v1.BackofficeWallet.ListFICAThresholdTransactions:output_type -> api.wallet.service.v1.ListFICAThresholdTransactionsResponse
	138, // 218: api.backoffice.service.v1.BackofficeWallet.ExportFICAThresholdTransactions:output_type -> api.wallet.service.v1.ExportFICAThresholdTransactionsResponse
	139, // 219: api.backoffice.service.v1.BackofficeWallet.ManualCredit:output_type -> api.wallet.service.v1.CreditResponse
	140, // 220: api.backoffice.service.v1.BackofficeWallet.ManualDebit:output_type -> api.wallet.service.v1.DebitResponse
	141, // 221: api.backoffice.service.v1.BackofficeWallet.ListManualJournalEntries:output_type -> api.wallet.service.v1.ListManualJournalEntriesResponse
	142, // 222: api.backoffice.service.v1.BackofficeWallet.ExportManualJournalEntries:output_type -> api.wallet.service.v1.ExportManualJournalEntriesResponse
	143, // 223: api.backoffice.service.v1.BackofficeWallet.ManualAdjustCreditTurnoverField:output_type -> api.wallet.service.v1.ManualAdjustCreditTurnoverFieldResponse
	144, // 224: api.backoffice.service.v1.BackofficeWallet.ListOperatorWithdrawableAmounts:output_type -> api.wallet.service.v1.ListOperatorWithdrawableAmountsResponse
	145, // 225: api.backoffice.service.v1.BackofficeWallet.GetOperatorWithdrawableAmount:output_type -> api.wallet.service.v1.GetOperatorWithdrawableAmountResponse
	146, // 226: api.backoffice.service.v1.BackofficeWallet.ListUserFreeRewards:output_type -> api.wallet.service.v1.ListUserFreeRewardsBOResponse
	163, // [163:227] is the sub-list for method output_type
	99,  // [99:163] is the sub-list for method input_type
...
func file_backoffice_service_v1_backoffice_wallet_proto_init() {
	...
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[39].OneofWrappers = []any{}
	...
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[59].OneofWrappers = []any{}
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[60].OneofWrappers = []any{}
	...
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[72].OneofWrappers = []any{}
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[73].OneofWrappers = []any{}
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[77].OneofWrappers = []any{}
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[79].OneofWrappers = []any{}
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[81].OneofWrappers = []any{}
	file_backoffice_service_v1_backoffice_wallet_proto_msgTypes[83].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_backoffice_service_v1_backoffice_wallet_proto_enumTypes,
