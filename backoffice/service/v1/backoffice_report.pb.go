...
func (x *ListSportEventsRequest) GetTimeRange() *TimeRange {
	if x != nil {
		return x.TimeRange
	}
	return nil
...
func (*CustomerRecordReportDetailResponse_UserDetail) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_report_proto_rawDescGZIP(), []int{32, 0}
}
...
func (*CustomerRecordReportDetailResponse_PaymentTransaction) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_report_proto_rawDescGZIP(), []int{32, 1}
}
...
type CustomerRecordReportDetailResponse_GameTransaction struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	GameTransactionId     int64                  `protobuf:"varint,1,opt,name=game_transaction_id,json=gameTransactionId,proto3" json:"game_transaction_id,omitempty"`
	...
	SettlementTime        string                 `protobuf:"bytes,3,opt,name=settlement_time,json=settlementTime,proto3" json:"settlement_time,omitempty"`
	Venue_Tournament      string                 `protobuf:"bytes,4,opt,name=venue_Tournament,json=venueTournament,proto3" json:"venue_Tournament,omitempty"`
	WagerType             string                 `protobuf:"bytes,5,opt,name=wager_type,json=wagerType,proto3" json:"wager_type,omitempty"`
	BetCurrency           string                 `protobuf:"bytes,6,opt,name=bet_currency,json=betCurrency,proto3" json:"bet_currency,omitempty"`
	BetAmount             string                 `protobuf:"bytes,7,opt,name=bet_amount,json=betAmount,proto3" json:"bet_amount,omitempty"`
	PayoutCurrency        string                 `protobuf:"bytes,8,opt,name=payout_currency,json=payoutCurrency,proto3" json:"payout_currency,omitempty"`
	PayoutAmount          string                 `protobuf:"bytes,9,opt,name=payout_amount,json=payoutAmount,proto3" json:"payout_amount,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (*CustomerRecordReportDetailResponse_GameTransaction) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_report_proto_rawDescGZIP(), []int{32, 2}
}
...
func (x *CustomerRecordReportDetailResponse_GameTransaction) GetSettlementTime() string {
	if x != nil {
		return x.SettlementTime
	}
	return ""
...
func (x *CustomerRecordReportDetailResponse_GameTransaction) GetVenue_Tournament() string {
	if x != nil {
		return x.Venue_Tournament
	}
	return ""
}
...
func (x *CustomerRecordReportDetailResponse_GameTransaction) GetPayoutCurrency() string {
	if x != nil {
		return x.PayoutCurrency
	}
	return ""
...
type CustomerRecordReportDetailResponse_EventSettlementInformation struct {
	state               protoimpl.MessageState                                                        `protogen:"open.v1"`
	SelectionBetDetails string                                                                        `protobuf:"bytes,1,opt,name=selection_bet_details,json=selectionBetDetails,proto3" json:"selection_bet_details,omitempty"`
	...
	SettlementDetails   string                                                                        `protobuf:"bytes,3,opt,name=settlement_details,json=settlementDetails,proto3" json:"settlement_details,omitempty"`
	MatchResults        []*CustomerRecordReportDetailResponse_EventSettlementInformation_MatchResults `protobuf:"bytes,4,rep,name=match_results,json=matchResults,proto3" json:"match_results,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (*CustomerRecordReportDetailResponse_EventSettlementInformation) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_report_proto_rawDescGZIP(), []int{32, 3}
}

func (x *CustomerRecordReportDetailResponse_EventSettlementInformation) GetSelectionBetDetails() string {
	if x != nil {
		return x.SelectionBetDetails
	}
	return ""
...
func (x *CustomerRecordReportDetailResponse_EventSettlementInformation) GetEventDescription() string {
	if x != nil {
		return x.EventDescription
	}
	return ""
...
func (x *CustomerRecordReportDetailResponse_EventSettlementInformation) GetSettlementDetails() string {
	if x != nil {
		return x.SettlementDetails
	}
	return ""
...
func (*CustomerRecordReportDetailResponse_EventSettlementInformation_MatchResults) Descriptor() ([]byte, []int) {
	return file_backoffice_service_v1_backoffice_report_proto_rawDescGZIP(), []int{32, 3, 0}
}
...
const file_backoffice_service_v1_backoffice_report_proto_rawDesc = "" +
	...
	"0deposit_minus_withdraw_amount_reporting_currency\x18  \x01(\tR+depositMinusWithdrawAmountReportingCurrency\"\xbb\x02\n" +
	"\x16ListSportEventsRequest\x12C\n" +
	"\n" +
	"time_range\x18\x01 \x01(\v2$.api.backoffice.service.v1.TimeRangeR\ttimeRange\x12\x17\n" +
	...
	"tournament\x88\x01\x01B\a\n" +
	"\x05_pageB\f\n" +
	"\n" +
	"_page_sizeB\r\n" +
	"\v_event_nameB\b\n" +
	"\x06_venueB\r\n" +
	"\v_tournament\"\xaf\x06\n" +
	...
	"\vgame_bet_id\x18\x01 \x01(\tR\tgameBetId\"\x90\n" +
	"\n" +
	"\"GetTransactionAndEventInfoResponse\x12x\n" +
	"\x10transaction_info\x18\x01 \x01(\v2M.api.backoffice.service.v1.GetTransactionAndEventInfoResponse.TransactionInfoR\x0ftransactionInfo\x12\x85\x01\n" +
	"\x15event_settlement_info\x18\x02 \x01(\v2Q.api.backoffice.service.v1.GetTransactionAndEventInfoResponse.EventSettlementInfoR\x13eventSettlementInfo\x1a\xa7\x06\n" +
	...
	"\x0eprocessing_fee\x18\t \x01(\tR\rprocessingFee\x1a\xfc\x02\n" +
	"\x0fGameTransaction\x12.\n" +
	"\x13game_transaction_id\x18\x01 \x01(\x03R\x11gameTransactionId\x126\n" +
	"\x17provider_transaction_id\x18\x02 \x01(\tR\x15providerTransactionId\x12'\n" +
	"\x0fsettlement_time\x18\x03 \x01(\tR\x0esettlementTime\x12)\n" +
	"\x10venue_Tournament\x18\x04 \x01(\tR\x0fvenueTournament\x12\x1d\n" +
	"\n" +
	"wager_type\x18\x05 \x01(\tR\twagerType\x12!\n" +
	"\fbet_currency\x18\x06 \x01(\tR\vbetCurrency\x12\x1d\n" +
	"\n" +
	"bet_amount\x18\a \x01(\tR\tbetAmount\x12'\n" +
	"\x0fpayout_currency\x18\b \x01(\tR\x0epayoutCurrency\x12#\n" +
	"\rpayout_amount\x18\t \x01(\tR\fpayoutAmount\x1a\x93\x03\n" +
	"\x1aEventSettlementInformation\x122\n" +
	"\x15selection_bet_details\x18\x01 \x01(\tR\x13selectionBetDetails\x12+\n" +
	"\x11event_description\x18\x02 \x01(\tR\x10eventDescription\x12-\n" +
	"\x12settlement_details\x18\x03 \x01(\tR\x11settlementDetails\x12\x8a\x01\n" +
	"\rmatch_results\x18\x04 \x03(\v2e.api.backoffice.service.v1.CustomerRecordReportDetailResponse.EventSettlementInformation.MatchResultsR\fmatchResults\x1aX\n" +
	"\fMatchResults\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x1c\n" +
	"\tselection\x18\x03 \x01(\tR\tselectionB\x0e\n" +
	"\f_user_detailB\x16\n" +
	"\x14_payment_transactionB\x13\n" +
	"\x11_game_transactionB\x1f\n" +
	"\x1d_event_settlement_information2\xd5\x17\n" +
	...
	"\x0fListSportEvents\x121.api.backoffice.service.v1.ListSportEventsRequest\x1a2.api.backoffice.service.v1.ListSportEventsResponse\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/v1/backoffice/report/sport-events/list\x12\xda\x01\n" +
	"\x1aGetTransactionAndEventInfo\x12<.api.backoffice.service.v1.GetTransactionAndEventInfoRequest\x1a=.api.backoffice.service.v1.GetTransactionAndEventInfoResponse\"?\x82\xd3\xe4\x93\x029:\x01*\"4/v1/backoffice/report/transaction-and-event-info/get\x12\xcf\x01\n" +
...
var file_backoffice_service_v1_backoffice_report_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_backoffice_service_v1_backoffice_report_proto_goTypes = []any{
	...
	(*GetTransactionAndEventInfoRequest)(nil),                                          // 29: api.backoffice.service.v1.GetTransactionAndEventInfoRequest
	(*GetTransactionAndEventInfoResponse)(nil),                                         // 30: api.backoffice.service.v1.GetTransactionAndEventInfoResponse
	(*CustomerRecordReportDetailRequest)(nil),                                          // 31: api.backoffice.service.v1.CustomerRecordReportDetailRequest
	(*CustomerRecordReportDetailResponse)(nil),                                         // 32: api.backoffice.service.v1.CustomerRecordReportDetailResponse
	(*ListSummariesResponse_List)(nil),                                                 // 33: api.backoffice.service.v1.ListSummariesResponse.List
	(*ListGameDataResponse_List)(nil),                                                  // 34: api.backoffice.service.v1.ListGameDataResponse.List
	(*ListPlayerGameDataResponse_List)(nil),                                            // 35: api.backoffice.service.v1.ListPlayerGameDataResponse.List
	(*GetDepositSummariesResponse_DepositSummary)(nil),                                 // 36: api.backoffice.service.v1.GetDepositSummariesResponse.DepositSummary
	(*ListDepositDetailsResponse_Detail)(nil),                                          // 37: api.backoffice.service.v1.ListDepositDetailsResponse.Detail
	(*GetWithdrawSummariesResponse_WithdrawSummary)(nil),                               // 38: api.backoffice.service.v1.GetWithdrawSummariesResponse.WithdrawSummary
	...
	(*ListSportEventsResponse_SportEvent)(nil),                                         // 43: api.backoffice.service.v1.ListSportEventsResponse.SportEvent
	(*GetTransactionAndEventInfoResponse_TransactionInfo)(nil),                         // 44: api.backoffice.service.v1.GetTransactionAndEventInfoResponse.TransactionInfo
	(*GetTransactionAndEventInfoResponse_EventSettlementInfo)(nil),                     // 45: api.backoffice.service.v1.GetTransactionAndEventInfoResponse.EventSettlementInfo
	(*CustomerRecordReportDetailResponse_UserDetail)(nil),                              // 46: api.backoffice.service.v1.CustomerRecordReportDetailResponse.UserDetail
	(*CustomerRecordReportDetailResponse_PaymentTransaction)(nil),                      // 47: api.backoffice.service.v1.CustomerRecordReportDetailResponse.PaymentTransaction
	(*CustomerRecordReportDetailResponse_GameTransaction)(nil),                         // 48: api.backoffice.service.v1.CustomerRecordReportDetailResponse.GameTransaction
	(*CustomerRecordReportDetailResponse_EventSettlementInformation)(nil),              // 49: api.backoffice.service.v1.CustomerRecordReportDetailResponse.EventSettlementInformation
	(*CustomerRecordReportDetailResponse_EventSettlementInformation_MatchResults)(nil), // 50: api.backoffice.service.v1.CustomerRecordReportDetailResponse.EventSettlementInformation.MatchResults
...
var file_backoffice_service_v1_backoffice_report_proto_depIdxs = []int32{
	...
	51, // 1: api.backoffice.service.v1.GetSummaryRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	0,  // 2: api.backoffice.service.v1.ListSummariesRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 3: api.backoffice.service.v1.ListSummariesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	33, // 4: api.backoffice.service.v1.ListSummariesResponse.list:type_name -> api.backoffice.service.v1.ListSummariesResponse.List
	0,  // 5: api.backoffice.service.v1.GetGameSummaryRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 6: api.backoffice.service.v1.GetGameSummaryRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	0,  // 7: api.backoffice.service.v1.ListGameDataRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 8: api.backoffice.service.v1.ListGameDataRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	34, // 9: api.backoffice.service.v1.ListGameDataResponse.list:type_name -> api.backoffice.service.v1.ListGameDataResponse.List
	0,  // 10: api.backoffice.service.v1.GetPlayerGameSummaryRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 11: api.backoffice.service.v1.GetPlayerGameSummaryRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	0,  // 12: api.backoffice.service.v1.ListPlayerGameDataRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 13: api.backoffice.service.v1.ListPlayerGameDataRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	35, // 14: api.backoffice.service.v1.ListPlayerGameDataResponse.list:type_name -> api.backoffice.service.v1.ListPlayerGameDataResponse.List
	0,  // 15: api.backoffice.service.v1.GetDepositSummariesRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 16: api.backoffice.service.v1.GetDepositSummariesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	36, // 17: api.backoffice.service.v1.GetDepositSummariesResponse.deposit_summaries:type_name -> api.backoffice.service.v1.GetDepositSummariesResponse.DepositSummary
	0,  // 18: api.backoffice.service.v1.ListDepositDetailsRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 19: api.backoffice.service.v1.ListDepositDetailsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	37, // 20: api.backoffice.service.v1.ListDepositDetailsResponse.details:type_name -> api.backoffice.service.v1.ListDepositDetailsResponse.Detail
	0,  // 21: api.backoffice.service.v1.GetWithdrawSummariesRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 22: api.backoffice.service.v1.GetWithdrawSummariesRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	38, // 23: api.backoffice.service.v1.GetWithdrawSummariesResponse.withdraw_summaries:type_name -> api.backoffice.service.v1.GetWithdrawSummariesResponse.WithdrawSummary
	0,  // 24: api.backoffice.service.v1.ListWithdrawDetailsRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 25: api.backoffice.service.v1.ListWithdrawDetailsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	39, // 26: api.backoffice.service.v1.ListWithdrawDetailsResponse.details:type_name -> api.backoffice.service.v1.ListWithdrawDetailsResponse.Detail
	0,  // 27: api.backoffice.service.v1.ListRegisterRetentionRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 28: api.backoffice.service.v1.ListRegisterRetentionRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	40, // 29: api.backoffice.service.v1.ListRegisterRetentionResponse.details:type_name -> api.backoffice.service.v1.ListRegisterRetentionResponse.List
	0,  // 30: api.backoffice.service.v1.ListDepositVtgDetailsRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 31: api.backoffice.service.v1.ListDepositVtgDetailsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	41, // 32: api.backoffice.service.v1.ListDepositVtgDetailsResponse.daily_details:type_name -> api.backoffice.service.v1.ListDepositVtgDetailsResponse.Detail
	0,  // 33: api.backoffice.service.v1.ListWithdrawVtgDetailsRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	51, // 34: api.backoffice.service.v1.ListWithdrawVtgDetailsRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	42, // 35: api.backoffice.service.v1.ListWithdrawVtgDetailsResponse.daily_details:type_name -> api.backoffice.service.v1.ListWithdrawVtgDetailsResponse.Detail
	0,  // 36: api.backoffice.service.v1.ListSportEventsRequest.time_range:type_name -> api.backoffice.service.v1.TimeRange
	43, // 37: api.backoffice.service.v1.ListSportEventsResponse.events:type_name -> api.backoffice.service.v1.ListSportEventsResponse.SportEvent
	44, // 38: api.backoffice.service.v1.GetTransactionAndEventInfoResponse.transaction_info:type_name -> api.backoffice.service.v1.GetTransactionAndEventInfoResponse.TransactionInfo
	45, // 39: api.backoffice.service.v1.GetTransactionAndEventInfoResponse.event_settlement_info:type_name -> api.backoffice.service.v1.GetTransactionAndEventInfoResponse.EventSettlementInfo
	46, // 40: api.backoffice.service.v1.CustomerRecordReportDetailResponse.user_detail:type_name -> api.backoffice.service.v1.CustomerRecordReportDetailResponse.UserDetail
	47, // 41: api.backoffice.service.v1.CustomerRecordReportDetailResponse.payment_transaction:type_name -> api.backoffice.service.v1.CustomerRecordReportDetailResponse.PaymentTransaction
	48, // 42: api.backoffice.service.v1.CustomerRecordReportDetailResponse.game_transaction:type_name -> api.backoffice.service.v1.CustomerRecordReportDetailResponse.GameTransaction
	49, // 43: api.backoffice.service.v1.CustomerRecordReportDetailResponse.event_settlement_information:type_name -> api.backoffice.service.v1.CustomerRecordReportDetailResponse.EventSettlementInformation
	52, // 44: api.backoffice.service.v1.ListSportEventsResponse.SportEvent.carded_time:type_name -> google.protobuf.Timestamp
	52, // 45: api.backoffice.service.v1.ListSportEventsResponse.SportEvent.first_bet_time:type_name -> google.protobuf.Timestamp
	52, // 46: api.backoffice.service.v1.ListSportEventsResponse.SportEvent.last_bet_time:type_name -> google.protobuf.Timestamp
	52, // 47: api.backoffice.service.v1.ListSportEventsResponse.SportEvent.no_more_bets_time:type_name -> google.protobuf.Timestamp
	52, // 48: api.backoffice.service.v1.ListSportEventsResponse.SportEvent.result_processing_time:type_name -> google.protobuf.Timestamp
	52, // 49: api.backoffice.service.v1.ListSportEventsResponse.SportEvent.revised_official_carded_time:type_name -> google.protobuf.Timestamp
	52, // 50: api.backoffice.service.v1.GetTransactionAndEventInfoResponse.TransactionInfo.settlement_time:type_name -> google.protobuf.Timestamp
	52, // 51: api.backoffice.service.v1.GetTransactionAndEventInfoResponse.TransactionInfo.event_start_time:type_name -> google.protobuf.Timestamp
	52, // 52: api.backoffice.service.v1.CustomerRecordReportDetailResponse.PaymentTransaction.arrival_time:type_name -> google.protobuf.Timestamp
	50, // 53: api.backoffice.service.v1.CustomerRecordReportDetailResponse.EventSettlementInformation.match_results:type_name -> api.backoffice.service.v1.CustomerRecordReportDetailResponse.EventSettlementInformation.MatchResults
	...
	29, // 68: api.backoffice.service.v1.BackofficeReport.GetTransactionAndEventInfo:input_type -> api.backoffice.service.v1.GetTransactionAndEventInfoRequest
	31, // 69: api.backoffice.service.v1.BackofficeReport.CustomerRecordReportDetail:input_type -> api.backoffice.service.v1.CustomerRecordReportDetailRequest
	2,  // 70: api.backoffice.service.v1.BackofficeReport.GetSummary:output_type -> api.backoffice.service.v1.GetSummaryResponse
	4,  // 71: api.backoffice.service.v1.BackofficeReport.ListSummaries:output_type -> api.backoffice.service.v1.ListSummariesResponse
	6,  // 72: api.backoffice.service.v1.BackofficeReport.GetGameDataSummary:output_type -> api.backoffice.service.v1.GetGameSummaryResponse
	8,  // 73: api.backoffice.service.v1.BackofficeReport.ListGameData:output_type -> api.backoffice.service.v1.ListGameDataResponse
	10, // 74: api.backoffice.service.v1.BackofficeReport.GetPlayerGameDataSummary:output_type -> api.backoffice.service.v1.GetPlayerGameSummaryResponse
	12, // 75: api.backoffice.service.v1.BackofficeReport.ListPlayerGameData:output_type -> api.backoffice.service.v1.ListPlayerGameDataResponse
	14, // 76: api.backoffice.service.v1.BackofficeReport.GetDepositSummaries:output_type -> api.backoffice.service.v1.GetDepositSummariesResponse
	16, // 77: api.backoffice.service.v1.BackofficeReport.ListDepositDetails:output_type -> api.backoffice.service.v1.ListDepositDetailsResponse
	18, // 78: api.backoffice.service.v1.BackofficeReport.GetWithdrawSummaries:output_type -> api.backoffice.service.v1.GetWithdrawSummariesResponse
	20, // 79: api.backoffice.service.v1.BackofficeReport.ListWithdrawDetails:output_type -> api.backoffice.service.v1.ListWithdrawDetailsResponse
	22, // 80: api.backoffice.service.v1.BackofficeReport.ListRegisterRetention:output_type -> api.backoffice.service.v1.ListRegisterRetentionResponse
	24, // 81: api.backoffice.service.v1.BackofficeReport.ListDepositVtgDetails:output_type -> api.backoffice.service.v1.ListDepositVtgDetailsResponse
	26, // 82: api.backoffice.service.v1.BackofficeReport.ListWithdrawVtgDetails:output_type -> api.backoffice.service.v1.ListWithdrawVtgDetailsResponse
	28, // 83: api.backoffice.service.v1.BackofficeReport.ListSportEvents:output_type -> api.backoffice.service.v1.ListSportEventsResponse
	30, // 84: api.backoffice.service.v1.BackofficeReport.GetTransactionAndEventInfo:output_type -> api.backoffice.service.v1.GetTransactionAndEventInfoResponse
	32, // 85: api.backoffice.service.v1.BackofficeReport.CustomerRecordReportDetail:output_type -> api.backoffice.service.v1.CustomerRecordReportDetailResponse
