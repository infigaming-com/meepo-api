...
const file_backoffice_service_v1_backoffice_user_proto_rawDesc = "" +
	...
	"\v_start_timeB\v\n" +
	"\t_end_time\"\x17\n" +
	"\x15PreLaunchCheckRequest2\x85\x19\n" +
	...
	"\x10UserIdentityList\x122.api.backoffice.service.v1.UserIdentityListRequest\x1a-.api.user.service.v1.UserIdentityListResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/backoffice/user/identity/list/get\x12\xa8\x01\n" +
	"\x0ePreLaunchCheck\x120.api.backoffice.service.v1.PreLaunchCheckRequest\x1a+.api.user.service.v1.PreLaunchCheckResponse\"7\x82\xd3\xe4\x93\x021:\x01*\",/v1/backoffice/user/operator/prelaunch/checkB[\n" +
...
var file_backoffice_service_v1_backoffice_user_proto_goTypes = []any{
	...
	(*PreLaunchCheckRequest)(nil),                      // 29: api.backoffice.service.v1.PreLaunchCheckRequest
...
var file_backoffice_service_v1_backoffice_user_proto_depIdxs = []int32{
	...
	30, // 3: api.backoffice.service.v1.ListUsersResponse.users:type_name -> api.backoffice.service.v1.ListUsersResponse.User
	31, // 4: api.backoffice.service.v1.GetUserOverviewResponse.game_data:type_name -> api.backoffice.service.v1.GetUserOverviewResponse.GameData
	32, // 5: api.backoffice.service.v1.ListUserCommentsResponse.comments:type_name -> api.backoffice.service.v1.ListUserCommentsResponse.Comment
	35, // 6: api.backoffice.service.v1.UpdateUserRequest.user_identity:type_name -> api.user.service.v1.UserIdentityRequest
	33, // 7: api.backoffice.service.v1.UpdateUserRequest.bod:type_name -> google.protobuf.Timestamp
	33, // 8: api.backoffice.service.v1.UserIdentityListRequest.start_time:type_name -> google.protobuf.Timestamp
	33, // 9: api.backoffice.service.v1.UserIdentityListRequest.end_time:type_name -> google.protobuf.Timestamp
	34, // 10: api.backoffice.service.v1.UserIdentityListRequest.operator_context_filters:type_name -> api.common.OperatorContextFilters
	33, // 11: api.backoffice.service.v1.ListUsersResponse.User.last_login_at:type_name -> google.protobuf.Timestamp
	33, // 12: api.backoffice.service.v1.ListUsersResponse.User.registered_at:type_name -> google.protobuf.Timestamp
	33, // 13: api.backoffice.service.v1.ListUserCommentsResponse.Comment.created_at:type_name -> google.protobuf.Timestamp
	...
	29, // 31: api.backoffice.service.v1.BackofficeUser.PreLaunchCheck:input_type -> api.backoffice.service.v1.PreLaunchCheckRequest
