...
const OperationBackofficePaymentGetOperatorPaymentChannelPage = "/api.backoffice.service.v1.BackofficePayment/GetOperatorPaymentChannelPage"
...
const OperationBackofficePaymentUpdatePaymentMethod = "/api.backoffice.service.v1.BackofficePayment/UpdatePaymentMethod"
...
type BackofficePaymentHTTPServer interface {
	...
	// GetOperatorPaymentChannelPage Get payment channel page with pagination and filters
...
func _BackofficePayment_GetOperatorPaymentChannelPage0_HTTP_Handler(srv BackofficePaymentHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetOperatorPaymentChannelPageRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationBackofficePaymentGetOperatorPaymentChannelPage)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetOperatorPaymentChannelPage(ctx, req.(*GetOperatorPaymentChannelPageRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type BackofficePaymentHTTPClient interface {
	...
	GetOperatorPaymentChannelPage(ctx context.Context, req *GetOperatorPaymentChannelPageRequest, opts ...http.CallOption) (rsp *v1.GetPaymentChannelPageResponse, err error)
	GetPaymentMethodList(ctx context.Context, req *GetPaymentMethodListRequest, opts ...http.CallOption) (rsp *v1.GetPaymentMethodListResponse, err error)
...
func (c *BackofficePaymentHTTPClientImpl) GetOperatorPaymentChannelPage(ctx context.Context, in *GetOperatorPaymentChannelPageRequest, opts ...http.CallOption) (*v1.GetPaymentChannelPageResponse, error) {
	var out v1.GetPaymentChannelPageResponse
	pattern := "/v1/backoffice/payment/channel/page"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficePaymentGetOperatorPaymentChannelPage))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *BackofficePaymentHTTPClientImpl) GetPaymentMethodList(ctx context.Context, in *GetPaymentMethodListRequest, opts ...http.CallOption) (*v1.GetPaymentMethodListResponse, error) {
...
func (c *BackofficePaymentHTTPClientImpl) GetPaymentTransactionById(ctx context.Context, in *v1.GetTransactionDetailByIdRequest, opts ...http.CallOption) (*v1.GetTransactionDetailByIdResponse, error) {
	var out v1.GetTransactionDetailByIdResponse
...
func (c *BackofficePaymentHTTPClientImpl) UpdatePaymentMethod(ctx context.Context, in *v1.UpdatePaymentMethodRequest, opts ...http.CallOption) (*v1.CreatePaymentMethodResponse, error) {
	...
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationBackofficePaymentUpdatePaymentMethod))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
