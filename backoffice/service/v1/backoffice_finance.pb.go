...
var file_backoffice_service_v1_backoffice_finance_proto_goTypes = []any{
	...
	(*ListInvoicesResponse_Invoice)(nil),                      // 33: api.backoffice.service.v1.ListInvoicesResponse.Invoice
	(*GetInvoiceDetailResponse_InvoiceDetail)(nil),            // 34: api.backoffice.service.v1.GetInvoiceDetailResponse.InvoiceDetail
	(*ListOperatorRevenueShareResponse_RevenueShareItem)(nil), // 35: api.backoffice.service.v1.ListOperatorRevenueShareResponse.RevenueShareItem
	(*ListThirdPartyFeesResponse_ThirdPartyFeeItem)(nil),      // 36: api.backoffice.service.v1.ListThirdPartyFeesResponse.ThirdPartyFeeItem
	(*ListMonthlyRevenueShareResponse_RevenueShareItem)(nil),  // 37: api.backoffice.service.v1.ListMonthlyRevenueShareResponse.RevenueShareItem
	(*ListMonthlyRevenueShareResponse_Summary)(nil),           // 38: api.backoffice.service.v1.ListMonthlyRevenueShareResponse.Summary
	(*ListAdjustmentConfigsResponse_AdjustmentConfig)(nil),    // 39: api.backoffice.service.v1.ListAdjustmentConfigsResponse.AdjustmentConfig
	(*ListAdjustmentsResponse_AdjustmentItem)(nil),            // 40: api.backoffice.service.v1.ListAdjustmentsResponse.AdjustmentItem
}
var file_backoffice_service_v1_backoffice_finance_proto_depIdxs = []int32{
	...
	33, // 1: api.backoffice.service.v1.ListInvoicesResponse.invoices:type_name -> api.backoffice.service.v1.ListInvoicesResponse.Invoice
	34, // 2: api.backoffice.service.v1.GetInvoiceDetailResponse.invoice:type_name -> api.backoffice.service.v1.GetInvoiceDetailResponse.InvoiceDetail
	35, // 3: api.backoffice.service.v1.ListOperatorRevenueShareResponse.items:type_name -> api.backoffice.service.v1.ListOperatorRevenueShareResponse.RevenueShareItem
	36, // 4: api.backoffice.service.v1.ListThirdPartyFeesResponse.items:type_name -> api.backoffice.service.v1.ListThirdPartyFeesResponse.ThirdPartyFeeItem
	37, // 5: api.backoffice.service.v1.ListMonthlyRevenueShareResponse.items:type_name -> api.backoffice.service.v1.ListMonthlyRevenueShareResponse.RevenueShareItem
	38, // 6: api.backoffice.service.v1.ListMonthlyRevenueShareResponse.summary:type_name -> api.backoffice.service.v1.ListMonthlyRevenueShareResponse.Summary
	39, // 7: api.backoffice.service.v1.ListAdjustmentConfigsResponse.configs:type_name -> api.backoffice.service.v1.ListAdjustmentConfigsResponse.AdjustmentConfig
	40, // 8: api.backoffice.service.v1.ListAdjustmentsResponse.items:type_name -> api.backoffice.service.v1.ListAdjustmentsResponse.AdjustmentItem
	...
	29, // 24: api.backoffice.service.v1.BackofficeFinance.GetBalanceSummary:input_type -> api.backoffice.service.v1.GetBalanceSummaryRequest
	31, // 25: api.backoffice.service.v1.BackofficeFinance.GetBalancesSummary:input_type -> api.backoffice.service.v1.GetBalancesSummaryRequest
	4,  // 26: api.backoffice.service.v1.BackofficeFinance.ListInvoices:output_type -> api.backoffice.service.v1.ListInvoicesResponse
	6,  // 27: api.backoffice.service.v1.BackofficeFinance.GetInvoiceDetail:output_type -> api.backoffice.service.v1.GetInvoiceDetailResponse
	8,  // 28: api.backoffice.service.v1.BackofficeFinance.ListOperatorRevenueShare:output_type -> api.backoffice.service.v1.ListOperatorRevenueShareResponse
	10, // 29: api.backoffice.service.v1.BackofficeFinance.ListThirdPartyFees:output_type -> api.backoffice.service.v1.ListThirdPartyFeesResponse
	22, // 30: api.backoffice.service.v1.BackofficeFinance.ListAdjustments:output_type -> api.backoffice.service.v1.ListAdjustmentsResponse
	12, // 31: api.backoffice.service.v1.BackofficeFinance.ListMonthlyRevenueShare:output_type -> api.backoffice.service.v1.ListMonthlyRevenueShareResponse
	14, // 32: api.backoffice.service.v1.BackofficeFinance.AddAdjustment:output_type -> api.backoffice.service.v1.AddAdjustmentResponse
	16, // 33: api.backoffice.service.v1.BackofficeFinance.ListAdjustmentConfigs:output_type -> api.backoffice.service.v1.ListAdjustmentConfigsResponse
	24, // 34: api.backoffice.service.v1.BackofficeFinance.CreateAdjustmentConfig:output_type -> api.backoffice.service.v1.CreateAdjustmentConfigResponse
	18, // 35: api.backoffice.service.v1.BackofficeFinance.UpdateAdjustmentConfig:output_type -> api.backoffice.service.v1.UpdateAdjustmentConfigResponse
	20, // 36: api.backoffice.service.v1.BackofficeFinance.DeleteAdjustmentConfig:output_type -> api.backoffice.service.v1.DeleteAdjustmentConfigResponse
	26, // 37: api.backoffice.service.v1.BackofficeFinance.SendInvoices:output_type -> api.backoffice.service.v1.SendInvoicesResponse
	28, // 38: api.backoffice.service.v1.BackofficeFinance.GetInvoiceSummary:output_type -> api.backoffice.service.v1.GetInvoiceSummaryResponse
	30, // 39: api.backoffice.service.v1.BackofficeFinance.GetBalanceSummary:output_type -> api.backoffice.service.v1.GetBalanceSummaryResponse
	32, // 40: api.backoffice.service.v1.BackofficeFinance.GetBalancesSummary:output_type -> api.backoffice.service.v1.GetBalancesSummaryResponse
