...
type ListTicketsRequest struct {
	...
	OperatorContexts         []*common.OperatorContext `protobuf:"bytes,3,rep,name=operator_contexts,json=operatorContexts,proto3" json:"operator_contexts,omitempty"`
	CompanyOperatorContexts  []*common.OperatorContext `protobuf:"bytes,4,rep,name=company_operator_contexts,json=companyOperatorContexts,proto3" json:"company_operator_contexts,omitempty"`
	RetailerOperatorContexts []*common.OperatorContext `protobuf:"bytes,5,rep,name=retailer_operator_contexts,json=retailerOperatorContexts,proto3" json:"retailer_operator_contexts,omitempty"`
	SystemOperatorContexts   []*common.OperatorContext `protobuf:"bytes,6,rep,name=system_operator_contexts,json=systemOperatorContexts,proto3" json:"system_operator_contexts,omitempty"`
...
func (x *ListTicketsRequest) GetOperatorContexts() []*common.OperatorContext {
	if x != nil {
...
func (x *ListTicketsRequest) GetCompanyOperatorContexts() []*common.OperatorContext {
	if x != nil {
...
func (x *ListTicketsRequest) GetRetailerOperatorContexts() []*common.OperatorContext {
	if x != nil {
...
func (x *ListTicketsRequest) GetSystemOperatorContexts() []*common.OperatorContext {
	if x != nil {
		return x.SystemOperatorContexts
	}
	return nil
}
...
type ListOperatorTicketsRequest struct {
	...
	OperatorContexts         []*common.OperatorContext `protobuf:"bytes,2,rep,name=operator_contexts,json=operatorContexts,proto3" json:"operator_contexts,omitempty"`
	...
	RetailerOperatorContexts []*common.OperatorContext `protobuf:"bytes,4,rep,name=retailer_operator_contexts,json=retailerOperatorContexts,proto3" json:"retailer_operator_contexts,omitempty"`
	SystemOperatorContexts   []*common.OperatorContext `protobuf:"bytes,5,rep,name=system_operator_contexts,json=systemOperatorContexts,proto3" json:"system_operator_contexts,omitempty"`
...
func (x *ListOperatorTicketsRequest) GetOperatorContexts() []*common.OperatorContext {
	if x != nil {
		return x.OperatorContexts
	}
	return nil
...
func (x *ListOperatorTicketsRequest) GetCompanyOperatorContexts() []*common.OperatorContext {
	if x != nil {
		return x.CompanyOperatorContexts
	}
	return nil
...
func (x *ListOperatorTicketsRequest) GetRetailerOperatorContexts() []*common.OperatorContext {
	if x != nil {
		return x.RetailerOperatorContexts
	}
	return nil
...
func (x *ListOperatorTicketsRequest) GetSystemOperatorContexts() []*common.OperatorContext {
	if x != nil {
		return x.SystemOperatorContexts
	}
	return nil
...
const file_backoffice_service_v1_backoffice_review_proto_rawDesc = "" +
	...
	"\tticket_id\x18\x01 \x01(\x03R\bticketId\"\xcb\x06\n" +
	"\x12ListTicketsRequest\x12\x1c\n" +
	"\auser_id\x18\x01 \x01(\x03H\x00R\x06userId\x88\x01\x01\x12F\n" +
	"\x10operator_context\x18\x02 \x01(\v2\x1b.api.common.OperatorContextR\x0foperatorContext\x12H\n" +
	"\x11operator_contexts\x18\x03 \x03(\v2\x1b.api.common.OperatorContextR\x10operatorContexts\x12W\n" +
	"\x19company_operator_contexts\x18\x04 \x03(\v2\x1b.api.common.OperatorContextR\x17companyOperatorContexts\x12Y\n" +
	"\x1aretailer_operator_contexts\x18\x05 \x03(\v2\x1b.api.common.OperatorContextR\x18retailerOperatorContexts\x12U\n" +
	"\x18system_operator_contexts\x18\x06 \x03(\v2\x1b.api.common.OperatorContextR\x16systemOperatorContexts\x12 \n" +
	"\tticket_id\x18\a \x01(\x03H\x01R\bticketId\x88\x01\x01\x12\x1f\n" +
	"\bcurrency\x18\b \x01(\tH\x02R\bcurrency\x88\x01\x01\x12\x1b\n" +
	"\x06status\x18\t \x01(\tH\x03R\x06status\x88\x01\x01\x12>\n" +
	"\n" +
	"start_time\x18\n" +
	...
	"\x04page\x18\f \x01(\x05H\x06R\x04page\x88\x01\x01\x12 \n" +
	"\tpage_size\x18\r \x01(\x05H\aR\bpageSize\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\f\n" +
	"\n" +
	"_ticket_idB\v\n" +
	...
	"\x10operator_context\x18\x01 \x01(\v2\x1b.api.common.OperatorContextR\x0foperatorContext\x12H\n" +
	"\x11operator_contexts\x18\x02 \x03(\v2\x1b.api.common.OperatorContextR\x10operatorContexts\x12W\n" +
	"\x19company_operator_contexts\x18\x03 \x03(\v2\x1b.api.common.OperatorContextR\x17companyOperatorContexts\x12Y\n" +
	"\x1aretailer_operator_contexts\x18\x04 \x03(\v2\x1b.api.common.OperatorContextR\x18retailerOperatorContexts\x12U\n" +
	"\x18system_operator_contexts\x18\x05 \x03(\v2\x1b.api.common.OperatorContextR\x16systemOperatorContexts\x12 \n" +
	"\tticket_id\x18\x06 \x01(\x03H\x00R\bticketId\x88\x01\x01\x12\x1f\n" +
	"\bcurrency\x18\a \x01(\tH\x01R\bcurrency\x88\x01\x01\x12\x1b\n" +
	"\x06status\x18\b \x01(\tH\x02R\x06status\x88\x01\x01\x12>\n" +
	"\n" +
	"start_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampH\x03R\tstartTime\x88\x01\x01\x12:\n" +
	"\bend_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampH\x04R\aendTime\x88\x01\x01\x12\x17\n" +
	"\x04page\x18\v \x01(\x05H\x05R\x04page\x88\x01\x01\x12 \n" +
	"\tpage_size\x18\f \x01(\x05H\x06R\bpageSize\x88\x01\x01B\f\n" +
	"\n" +
	"_ticket_idB\v\n" +
	"\t_currencyB\t\n" +
	"\a_statusB\r\n" +
...
var file_backoffice_service_v1_backoffice_review_proto_depIdxs = []int32{
	...
	30, // 2: api.backoffice.service.v1.ListTicketsRequest.operator_contexts:type_name -> api.common.OperatorContext
	30, // 3: api.backoffice.service.v1.ListTicketsRequest.company_operator_contexts:type_name -> api.common.OperatorContext
	30, // 4: api.backoffice.service.v1.ListTicketsRequest.retailer_operator_contexts:type_name -> api.common.OperatorContext
	30, // 5: api.backoffice.service.v1.ListTicketsRequest.system_operator_contexts:type_name -> api.common.OperatorContext
	31, // 6: api.backoffice.service.v1.ListTicketsRequest.start_time:type_name -> google.protobuf.Timestamp
	31, // 7: api.backoffice.service.v1.ListTicketsRequest.end_time:type_name -> google.protobuf.Timestamp
	30, // 8: api.backoffice.service.v1.ListOperatorTicketsRequest.operator_context:type_name -> api.common.OperatorContext
	30, // 9: api.backoffice.service.v1.ListOperatorTicketsRequest.operator_contexts:type_name -> api.common.OperatorContext
	30, // 10: api.backoffice.service.v1.ListOperatorTicketsRequest.company_operator_contexts:type_name -> api.common.OperatorContext
	30, // 11: api.backoffice.service.v1.ListOperatorTicketsRequest.retailer_operator_contexts:type_name -> api.common.OperatorContext
	30, // 12: api.backoffice.service.v1.ListOperatorTicketsRequest.system_operator_contexts:type_name -> api.common.OperatorContext
	31, // 13: api.backoffice.service.v1.ListOperatorTicketsRequest.start_time:type_name -> google.protobuf.Timestamp
	31, // 14: api.backoffice.service.v1.ListOperatorTicketsRequest.end_time:type_name -> google.protobuf.Timestamp
	17, // 15: api.backoffice.service.v1.ListTicketsResponse.tickets:type_name -> api.backoffice.service.v1.ListTicketsResponse.Ticket
	18, // 16: api.backoffice.service.v1.GetTicketResponse.withdraw_payment_info:type_name -> api.backoffice.service.v1.GetTicketResponse.WithdrawPaymentInfo
	19, // 17: api.backoffice.service.v1.GetTicketResponse.user_wallet_data:type_name -> api.backoffice.service.v1.GetTicketResponse.UserWalletData
	20, // 18: api.backoffice.service.v1.GetTicketResponse.comments:type_name -> api.backoffice.service.v1.GetTicketResponse.Comment
	21, // 19: api.backoffice.service.v1.GetOperatorTicketResponse.ticket:type_name -> api.backoffice.service.v1.GetOperatorTicketResponse.Ticket
	22, // 20: api.backoffice.service.v1.GetOperatorTicketResponse.comments:type_name -> api.backoffice.service.v1.GetOperatorTicketResponse.Comment
	23, // 21: api.backoffice.service.v1.GetOperatorTicketResponse.payment_withdraw_transaction_info:type_name -> api.backoffice.service.v1.GetOperatorTicketResponse.PaymentWithdrawTransactionInfo
	24, // 22: api.backoffice.service.v1.GetOperatorTicketResponse.wallet_balance_info:type_name -> api.backoffice.service.v1.GetOperatorTicketResponse.WalletBalanceInfo
	25, // 23: api.backoffice.service.v1.GetOperatorTicketResponse.wallet_transaction_info:type_name -> api.backoffice.service.v1.GetOperatorTicketResponse.WalletTransactionInfo
	26, // 24: api.backoffice.service.v1.GetOperatorTicketResponse.wallet_transaction_summary:type_name -> api.backoffice.service.v1.GetOperatorTicketResponse.WalletTransactionSummary
	27, // 25: api.backoffice.service.v1.GetTicketByIdResponse.ticket:type_name -> api.backoffice.service.v1.GetTicketByIdResponse.Ticket
	28, // 26: api.backoffice.service.v1.GetTicketByIdResponse.comments:type_name -> api.backoffice.service.v1.GetTicketByIdResponse.Comment
	31, // 27: api.backoffice.service.v1.ListTicketsResponse.Ticket.created_at:type_name -> google.protobuf.Timestamp
	31, // 28: api.backoffice.service.v1.GetTicketResponse.WithdrawPaymentInfo.created_at:type_name -> google.protobuf.Timestamp
	29, // 29: api.backoffice.service.v1.GetTicketResponse.WithdrawPaymentInfo.extra:type_name -> google.protobuf.Struct
	29, // 30: api.backoffice.service.v1.GetTicketResponse.WithdrawPaymentInfo.schema:type_name -> google.protobuf.Struct
	31, // 31: api.backoffice.service.v1.GetTicketResponse.Comment.created_at:type_name -> google.protobuf.Timestamp
	31, // 32: api.backoffice.service.v1.GetOperatorTicketResponse.Ticket.created_at:type_name -> google.protobuf.Timestamp
	31, // 33: api.backoffice.service.v1.GetOperatorTicketResponse.Comment.created_at:type_name -> google.protobuf.Timestamp
	31, // 34: api.backoffice.service.v1.GetOperatorTicketResponse.PaymentWithdrawTransactionInfo.created_at:type_name -> google.protobuf.Timestamp
	0,  // 35: api.backoffice.service.v1.BackofficeReview.CreateOperatorWithdraw:input_type -> api.backoffice.service.v1.CreateOperatorWithdrawRequest
	2,  // 36: api.backoffice.service.v1.BackofficeReview.ListTickets:input_type -> api.backoffice.service.v1.ListTicketsRequest
	3,  // 37: api.backoffice.service.v1.BackofficeReview.ListOperatorTickets:input_type -> api.backoffice.service.v1.ListOperatorTicketsRequest
	5,  // 38: api.backoffice.service.v1.BackofficeReview.GetTicket:input_type -> api.backoffice.service.v1.GetTicketRequest
	7,  // 39: api.backoffice.service.v1.BackofficeReview.GetOperatorTicket:input_type -> api.backoffice.service.v1.GetOperatorTicketRequest
	9,  // 40: api.backoffice.service.v1.BackofficeReview.ReviewTicket:input_type -> api.backoffice.service.v1.ReviewTicketRequest
	11, // 41: api.backoffice.service.v1.BackofficeReview.AddComment:input_type -> api.backoffice.service.v1.AddCommentRequest
	13, // 42: api.backoffice.service.v1.BackofficeReview.CancelTicket:input_type -> api.backoffice.service.v1.CancelTicketRequest
	15, // 43: api.backoffice.service.v1.BackofficeReview.GetTicketById:input_type -> api.backoffice.service.v1.GetTicketByIdRequest
	1,  // 44: api.backoffice.service.v1.BackofficeReview.CreateOperatorWithdraw:output_type -> api.backoffice.service.v1.CreateWithdrawResponse
	4,  // 45: api.backoffice.service.v1.BackofficeReview.ListTickets:output_type -> api.backoffice.service.v1.ListTicketsResponse
	4,  // 46: api.backoffice.service.v1.BackofficeReview.ListOperatorTickets:output_type -> api.backoffice.service.v1.ListTicketsResponse
	6,  // 47: api.backoffice.service.v1.BackofficeReview.GetTicket:output_type -> api.backoffice.service.v1.GetTicketResponse
	8,  // 48: api.backoffice.service.v1.BackofficeReview.GetOperatorTicket:output_type -> api.backoffice.service.v1.GetOperatorTicketResponse
	10, // 49: api.backoffice.service.v1.BackofficeReview.ReviewTicket:output_type -> api.backoffice.service.v1.ReviewTicketResponse
	12, // 50: api.backoffice.service.v1.BackofficeReview.AddComment:output_type -> api.backoffice.service.v1.AddCommentResponse
	14, // 51: api.backoffice.service.v1.BackofficeReview.CancelTicket:output_type -> api.backoffice.service.v1.CancelTicketResponse
	16, // 52: api.backoffice.service.v1.BackofficeReview.GetTicketById:output_type -> api.backoffice.service.v1.GetTicketByIdResponse
