...
const file_backoffice_service_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"(backoffice/service/v1/error_reason.proto\x12\x19api.backoffice.service.v1\x1a\x13errors/errors.proto*\x8b\x01\n" +
	"\vErrorReason\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12 \n" +
	"\x1aCALL_WALLET_SERVICE_FAILED\x10\xe0\xd4\x03\x12$\n" +
	"\x1eUSER_INFO_NOT_FOUND_IN_CONTEXT\x10\xe1\xd4\x03\x12\x1d\n" +
	"\x17REPORT_TIME_RANGE_ERROR\x10\xe2\xd4\x03\x1a\x04\xa0E\xf4\x03B[\n" +
