...
type AddAdjustmentRequest struct {
	...
	AppiedDate    string `protobuf:"bytes,5,opt,name=appied_date,json=appiedDate,proto3" json:"appied_date,omitempty"` // Applied date
...
func (x *AddAdjustmentRequest) GetAppiedDate() string {
	if x != nil {
		return x.AppiedDate
	}
	return ""
...
const file_operator_service_v1_operator_proto_rawDesc = "" +
	...
	"\x1brevenue_share_collect_total\x18\x03 \x01(\tR\x18revenueShareCollectTotal\"\x82\x02\n" +
