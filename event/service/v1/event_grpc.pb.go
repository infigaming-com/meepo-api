...
const (
	Event_Event_FullMethodName = "/api.event.service.v1.Event/Event"
)
...
func (c *eventClient) Event(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EventResponse)
	err := c.cc.Invoke(ctx, Event_Event_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEventServer) Event(context.Context, *EventRequest) (*EventResponse, error) {
...
func _Event_Event_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Event_Event_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServer).Event(ctx, req.(*EventRequest))
	}
...
var Event_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.event.service.v1.Event",
	...
	Metadata: "event/service/v1/event.proto",
}
